...
prompt  APPLICATION 106 - Adv APEX - Chap 12 - EX1
--
-- Application Export:
--   Application:     106
--   Name:            Adv APEX - Chap 12 - EX1
--   Date and Time:   20:01 Sunday February 27, 2011
--   Exported By:     GIFFY
--   Flashback:       0
...
wwv_flow_api.create_flow(
  ...
  p_name  => nvl(wwv_flow_application_install.get_application_name,'Adv APEX - Chap 12 - EX1'),
  p_alias => nvl(wwv_flow_application_install.get_application_alias,'106'),
  p_page_view_logging => 'YES',
  p_default_page_template=> 1615707579901481 + wwv_flow_api.g_id_offset,
  p_printer_friendly_template=> 1615903932901481 + wwv_flow_api.g_id_offset,
  p_default_region_template=> 1618213075901497 + wwv_flow_api.g_id_offset,
  p_error_template=> 1615707579901481 + wwv_flow_api.g_id_offset,
  p_page_protection_enabled_y_n=> 'Y',
  p_checksum_salt_last_reset => '20110225173947',
  ...
  p_cust_authentication_process=> '.'||to_char(1622903114901580 + wwv_flow_api.g_id_offset)||'.',
  ...
  p_theme_id => 1,
  p_default_label_template => 1621628637901527 + wwv_flow_api.g_id_offset,
  p_default_report_template => 1620903803901524 + wwv_flow_api.g_id_offset,
  p_default_list_template => 1620219136901512 + wwv_flow_api.g_id_offset,
  p_default_menu_template => 1621902103901528 + wwv_flow_api.g_id_offset,
  p_default_button_template => 1616409173901483 + wwv_flow_api.g_id_offset,
  p_default_chart_template => 1617327708901496 + wwv_flow_api.g_id_offset,
  p_default_form_template => 1617415723901496 + wwv_flow_api.g_id_offset,
  p_default_wizard_template => 1618822226901499 + wwv_flow_api.g_id_offset,
  p_default_tabform_template => 1618213075901497 + wwv_flow_api.g_id_offset,
  p_default_reportr_template   =>1618213075901497 + wwv_flow_api.g_id_offset,
  p_default_menur_template => 1617021199901495 + wwv_flow_api.g_id_offset,
  p_default_listr_template => 1617617663901496 + wwv_flow_api.g_id_offset,
  p_default_irr_template => 1617909465901497 + wwv_flow_api.g_id_offset,
  p_last_updated_by => 'GIFFY',
  p_last_upd_yyyymmddhh24miss=> '20110225173947',
...
wwv_flow_api.create_icon_bar_item(
  p_id => 1623227390901582 + wwv_flow_api.g_id_offset,
...
wwv_flow_api.create_flow_item(
  p_id=> 1625118158902636 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
...
--application/shared_components/navigation/tabs/standard/t_da_demo_1
wwv_flow_api.create_tab (
  p_id=> 1624627225901648 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_tab_set=> 'TS1',
  p_tab_sequence=> 10,
  p_tab_name=> 'T_DA_DEMO_1',
  p_tab_text => 'DA Demo - 1',
  p_tab_step => 1,
...
wwv_flow_api.create_page_plug (
  p_id=> 1624701266901653 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_page_id=> 1,
  p_plug_name=> 'Select Employee',
  p_region_name=>'',
  p_plug_template=> 1618213075901497+ wwv_flow_api.g_id_offset,
...
wwv_flow_api.create_page_item(
  p_id=>1626204015999162 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_flow_step_id=> 1,
  p_name=>'P1_DEPTNO',
  p_data_type=> 'VARCHAR',
  ...
  p_item_sequence=> 10,
  p_item_plug_id => 1624701266901653+wwv_flow_api.g_id_offset,
...
'order by 1',
  ...
  p_field_template=> 1621628637901527+wwv_flow_api.g_id_offset,
  p_is_persistent=> 'Y',
  p_attribute_01 => 'NONE',
  p_attribute_02 => 'N',
  p_item_comment => '');
...
begin
wwv_flow_api.create_page_item(
  p_id=>1628217830048787 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_flow_step_id=> 1,
  p_name=>'P1_EMPNO',
  p_data_type=> 'VARCHAR',
...
wwv_flow_api.create_page_da_event (
  p_id => 1638723808999968 + wwv_flow_api.g_id_offset
 ,p_flow_id => wwv_flow.g_flow_id
 ,p_page_id => 1
 ,p_name => 'Show Hide EmpNo'
 ,p_event_sequence => 10
...
wwv_flow_api.create_page_da_action (
  p_id => 1639020150999969 + wwv_flow_api.g_id_offset
 ,p_flow_id => wwv_flow.g_flow_id
 ,p_page_id => 1
 ,p_event_id => 1638723808999968 + wwv_flow_api.g_id_offset
 ,p_event_result => 'TRUE'
...
wwv_flow_api.create_page_da_action (
  p_id => 1639208488999970 + wwv_flow_api.g_id_offset
 ,p_flow_id => wwv_flow.g_flow_id
 ,p_page_id => 1
 ,p_event_id => 1638723808999968 + wwv_flow_api.g_id_offset
...
wwv_flow_api.create_page (
 ...
 ,p_step_template => 1614907254901469 + wwv_flow_api.g_id_offset
 ,p_page_is_public_y_n => 'N'
 ,p_cache_page_yn => 'N'
...
s := null;
wwv_flow_api.create_page_plug (
  p_id=> 1623510318901603 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_page_id=> 101,
  p_plug_name=> 'Login',
  p_region_name=>'',
  p_plug_template=> 1617415723901496+ wwv_flow_api.g_id_offset,
  p_plug_display_sequence=> 10,
  p_plug_display_column=> 1,
  p_plug_display_point=> 'AFTER_SHOW_ITEMS',
  p_plug_source=> s,
...
begin
wwv_flow_api.create_page_item(
  p_id=>1623617137901619 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_flow_step_id=> 101,
  ...
  p_accept_processing=> 'REPLACE_EXISTING',
  p_item_sequence=> 10,
  p_item_plug_id => 1623510318901603+wwv_flow_api.g_id_offset,
...
begin
wwv_flow_api.create_page_item(
  p_id=>1623719761901628 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_flow_step_id=> 101,
...
begin
wwv_flow_api.create_page_item(
  p_id=>1623830993901628 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_flow_step_id=> 101,
  p_name=>'P101_LOGIN',
  p_data_type=> '',
  ...
  p_cMaxlength=> null,
  p_cHeight=> null,
  p_tag_attributes  => 'template:'||to_char(1616409173901483 + wwv_flow_api.g_id_offset),
...
wwv_flow_api.create_page_process(
  p_id     => 1624000944901635 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_flow_step_id => 101,
...
wwv_flow_api.create_page_process(
  p_id     => 1623912222901632 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_flow_step_id => 101,
...
wwv_flow_api.create_page_process(
  p_id     => 1624227131901636 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_flow_step_id => 101,
...
wwv_flow_api.create_page_process(
  p_id     => 1624128521901635 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_flow_step_id => 101,
  p_process_sequence=> 10,
...
wwv_flow_api.create_menu (
  p_id=> 1624332155901636 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_name=> ' Breadcrumb');
 
wwv_flow_api.create_menu_option (
  p_id=>1624827845901665 + wwv_flow_api.g_id_offset,
  p_menu_id=>1624332155901636 + wwv_flow_api.g_id_offset,
  p_parent_id=>0,
...
prompt  ......Page template 1614907254901469
...
wwv_flow_api.create_template(
  p_id=> 1614907254901469 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_name=> 'Login',
  p_body_title=> '',
...
prompt  ......Page template 1615000690901477
...
wwv_flow_api.create_template(
  p_id=> 1615000690901477 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
...
prompt  ......Page template 1615122000901478
...
wwv_flow_api.create_template(
  p_id=> 1615122000901478 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
...
prompt  ......Page template 1615213014901479
...
wwv_flow_api.create_template(
  p_id=> 1615213014901479 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
...
prompt  ......Page template 1615332327901480
...
wwv_flow_api.create_template(
  p_id=> 1615332327901480 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
...
prompt  ......Page template 1615429798901480
...
wwv_flow_api.create_template(
  p_id=> 1615429798901480 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
...
prompt  ......Page template 1615529910901481
...
wwv_flow_api.create_template(
  p_id=> 1615529910901481 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
...
prompt  ......Page template 1615611505901481
...
wwv_flow_api.create_template(
  p_id=> 1615611505901481 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
...
prompt  ......Page template 1615707579901481
...
wwv_flow_api.create_template(
  p_id=> 1615707579901481 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
...
prompt  ......Page template 1615826046901481
...
wwv_flow_api.create_template(
  p_id=> 1615826046901481 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_name=> 'Popup',
  p_body_title=> '',
  p_header_template=> c1,
...
prompt  ......Page template 1615903932901481
...
wwv_flow_api.create_template(
  p_id=> 1615903932901481 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
...
prompt  ......Page template 1616024531901482
...
wwv_flow_api.create_template(
  p_id=> 1616024531901482 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
...
prompt  ......Page template 1616104434901482
...
wwv_flow_api.create_template(
  p_id=> 1616104434901482 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
...
prompt  ......Page template 1616224032901482
...
wwv_flow_api.create_template(
  p_id=> 1616224032901482 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
...
prompt  ......Page template 1616316404901483
...
wwv_flow_api.create_template(
  p_id=> 1616316404901483 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
...
prompt  ......Button Template 1616409173901483
declare
...
wwv_flow_api.create_button_templates (
  p_id=>1616409173901483 + wwv_flow_api.g_id_offset,
  p_flow_id=>wwv_flow.g_flow_id,
  p_template=>t,
...
prompt  ......Button Template 1616523253901487
declare
  t varchar2(32767) := null;
  l_clob clob;
  l_length number := 1;
...
wwv_flow_api.create_button_templates (
  p_id=>1616523253901487 + wwv_flow_api.g_id_offset,
  p_flow_id=>wwv_flow.g_flow_id,
  p_template=>t,
...
prompt  ......Button Template 1616613836901487
declare
  t varchar2(32767) := null;
  l_clob clob;
  l_length number := 1;
...
wwv_flow_api.create_button_templates (
  p_id=>1616613836901487 + wwv_flow_api.g_id_offset,
  p_flow_id=>wwv_flow.g_flow_id,
  p_template=>t,
...
prompt  ......Button Template 1616722865901488
declare
  t varchar2(32767) := null;
  l_clob clob;
  l_length number := 1;
...
wwv_flow_api.create_button_templates (
  p_id=>1616722865901488 + wwv_flow_api.g_id_offset,
  p_flow_id=>wwv_flow.g_flow_id,
  p_template=>t,
...
prompt  ......region template 1616823102901488
 
begin
 
wwv_flow_api.create_plug_template (
  p_id => 1616823102901488 + wwv_flow_api.g_id_offset
 ,p_flow_id => wwv_flow.g_flow_id
 ,p_template => 
...
prompt  ......region template 1616920475901495
 
begin
 
wwv_flow_api.create_plug_template (
  p_id => 1616920475901495 + wwv_flow_api.g_id_offset
 ,p_flow_id => wwv_flow.g_flow_id
 ,p_template => 
...
prompt  ......region template 1617021199901495
 
begin
 
wwv_flow_api.create_plug_template (
  p_id => 1617021199901495 + wwv_flow_api.g_id_offset
 ,p_flow_id => wwv_flow.g_flow_id
 ,p_template => 
...
prompt  ......region template 1617109033901496
 
begin
 
wwv_flow_api.create_plug_template (
  p_id => 1617109033901496 + wwv_flow_api.g_id_offset
 ,p_flow_id => wwv_flow.g_flow_id
 ,p_template => 
'<div class="borderless-region" id="#REGION_STATIC_ID#" #REGION_ATTRIBUTES#>'||chr(10)||
'  <div class="bl-top">'||chr(10)||
...
prompt  ......region template 1617220747901496
 
begin
 
wwv_flow_api.create_plug_template (
  p_id => 1617220747901496 + wwv_flow_api.g_id_offset
 ,p_flow_id => wwv_flow.g_flow_id
 ,p_template => 
'<div class="borderless-region" id="#REGION_STATIC_ID#" #REGION_ATTRIBUTES#>'||chr(10)||
'  <div class="bl-top">'||chr(10)||
...
prompt  ......region template 1617327708901496
 
begin
 
wwv_flow_api.create_plug_template (
  p_id => 1617327708901496 + wwv_flow_api.g_id_offset
 ,p_flow_id => wwv_flow.g_flow_id
 ,p_template => 
...
prompt  ......region template 1617415723901496
 
begin
 
wwv_flow_api.create_plug_template (
  p_id => 1617415723901496 + wwv_flow_api.g_id_offset
 ,p_flow_id => wwv_flow.g_flow_id
 ,p_template => 
'<div class="rounded-corner-region" id="#REGION_STATIC_ID#" #REGION_ATTRIBUTES#>'||chr(10)||
...
prompt  ......region template 1617501898901496
 
begin
 
wwv_flow_api.create_plug_template (
  p_id => 1617501898901496 + wwv_flow_api.g_id_offset
 ,p_flow_id => wwv_flow.g_flow_id
 ,p_template => 
...
prompt  ......region template 1617617663901496
 
begin
 
wwv_flow_api.create_plug_template (
  p_id => 1617617663901496 + wwv_flow_api.g_id_offset
 ,p_flow_id => wwv_flow.g_flow_id
 ,p_template => 
'<div class="rounded-corner-region" id="#REGION_STATIC_ID#" #REGION_ATTRIBUTES#>'||chr(10)||
'  <div class="rc-red-top"><div class="rc-red-top-r">'||chr(10)||
...
prompt  ......region template 1617725908901496
 
begin
 
wwv_flow_api.create_plug_template (
  p_id => 1617725908901496 + wwv_flow_api.g_id_offset
 ,p_flow_id => wwv_flow.g_flow_id
 ,p_template => 
...
prompt  ......region template 1617810631901496
 
begin
 
wwv_flow_api.create_plug_template (
  p_id => 1617810631901496 + wwv_flow_api.g_id_offset
 ,p_flow_id => wwv_flow.g_flow_id
 ,p_template => 
...
prompt  ......region template 1617909465901497
 
begin
 
wwv_flow_api.create_plug_template (
  p_id => 1617909465901497 + wwv_flow_api.g_id_offset
 ,p_flow_id => wwv_flow.g_flow_id
 ,p_template => 
'<div class="borderless-region" id="#REGION_STATIC_ID#" #REGION_ATTRIBUTES#>'||chr(10)||
'  <div class="bl-body">#BODY#</div>'||chr(10)||
...
prompt  ......region template 1618011756901497
 
begin
 
wwv_flow_api.create_plug_template (
  p_id => 1618011756901497 + wwv_flow_api.g_id_offset
 ,p_flow_id => wwv_flow.g_flow_id
 ,p_template => 
'<div class="borderless-region" id="#REGION_STATIC_ID#" #REGION_ATTRIBUTES#>'||chr(10)||
'  <div class="bl-top">'||chr(10)||
...
prompt  ......region template 1618107771901497
 
begin
 
wwv_flow_api.create_plug_template (
  p_id => 1618107771901497 + wwv_flow_api.g_id_offset
 ,p_flow_id => wwv_flow.g_flow_id
 ,p_template => 
...
prompt  ......region template 1618213075901497
 
begin
 
wwv_flow_api.create_plug_template (
  p_id => 1618213075901497 + wwv_flow_api.g_id_offset
 ,p_flow_id => wwv_flow.g_flow_id
 ,p_template => 
'<div class="rounded-corner-region" id="#REGION_STATIC_ID#" #REGION_ATTRIBUTES#>'||chr(10)||
'  <div class="rc-gray-top"><div class="rc-gray-top-r">'||chr(10)||
...
prompt  ......region template 1618302802901497
 
begin
 
wwv_flow_api.create_plug_template (
  p_id => 1618302802901497 + wwv_flow_api.g_id_offset
 ,p_flow_id => wwv_flow.g_flow_id
 ,p_template => 
...
prompt  ......region template 1618416704901497
 
begin
 
wwv_flow_api.create_plug_template (
  p_id => 1618416704901497 + wwv_flow_api.g_id_offset
 ,p_flow_id => wwv_flow.g_flow_id
 ,p_template => 
'<div class="rounded-corner-region" id="#REGION_STATIC_ID#" #REGION_ATTRIBUTES#>'||chr(10)||
'  <div class="rc-red-top"><div class="rc-red-top-r">'||chr(10)||
...
prompt  ......region template 1618522531901497
 
begin
 
wwv_flow_api.create_plug_template (
  p_id => 1618522531901497 + wwv_flow_api.g_id_offset
 ,p_flow_id => wwv_flow.g_flow_id
 ,p_template => 
...
prompt  ......region template 1618624702901499
 
begin
 
wwv_flow_api.create_plug_template (
  p_id => 1618624702901499 + wwv_flow_api.g_id_offset
 ,p_flow_id => wwv_flow.g_flow_id
 ,p_template => 
...
prompt  ......region template 1618704891901499
 
begin
 
wwv_flow_api.create_plug_template (
  p_id => 1618704891901499 + wwv_flow_api.g_id_offset
 ,p_flow_id => wwv_flow.g_flow_id
 ,p_template => 
...
prompt  ......region template 1618822226901499
 
begin
 
wwv_flow_api.create_plug_template (
  p_id => 1618822226901499 + wwv_flow_api.g_id_offset
 ,p_flow_id => wwv_flow.g_flow_id
 ,p_template => 
'<div class="rounded-corner-region" id="#REGION_STATIC_ID#" #REGION_ATTRIBUTES#>'||chr(10)||
'  <div class="rc-red-top"><div class="rc-red-top-r">'||chr(10)||
...
prompt  ......region template 1618913715901499
 
begin
 
wwv_flow_api.create_plug_template (
  p_id => 1618913715901499 + wwv_flow_api.g_id_offset
 ,p_flow_id => wwv_flow.g_flow_id
 ,p_template => 
'<div class="rounded-corner-region" id="#REGION_STATIC_ID#" #REGION_ATTRIBUTES#>'||chr(10)||
'  <div class="rc-red-top"><div class="rc-red-top-r">'||chr(10)||
...
prompt  ......list template 1619013596901499
...
wwv_flow_api.create_list_template (
  p_id=>1619013596901499 + wwv_flow_api.g_id_offset,
  p_flow_id=>wwv_flow.g_flow_id,
...
prompt  ......list template 1619106762901509
...
wwv_flow_api.create_list_template (
  p_id=>1619106762901509 + wwv_flow_api.g_id_offset,
  p_flow_id=>wwv_flow.g_flow_id,
  p_list_template_current=>t,
  p_list_template_noncurrent=> t2,
...
prompt  ......list template 1619207151901510
...
wwv_flow_api.create_list_template (
  p_id=>1619207151901510 + wwv_flow_api.g_id_offset,
  p_flow_id=>wwv_flow.g_flow_id,
  p_list_template_current=>t,
  p_list_template_noncurrent=> t2,
...
prompt  ......list template 1619330466901510
...
t8 := null;
wwv_flow_api.create_list_template (
  p_id=>1619330466901510 + wwv_flow_api.g_id_offset,
  p_flow_id=>wwv_flow.g_flow_id,
  p_list_template_current=>t,
  p_list_template_noncurrent=> t2,
...
prompt  ......list template 1619424530901511
...
t8 := null;
wwv_flow_api.create_list_template (
  p_id=>1619424530901511 + wwv_flow_api.g_id_offset,
  p_flow_id=>wwv_flow.g_flow_id,
  p_list_template_current=>t,
  p_list_template_noncurrent=> t2,
...
prompt  ......list template 1619504761901511
...
wwv_flow_api.create_list_template (
  p_id=>1619504761901511 + wwv_flow_api.g_id_offset,
  p_flow_id=>wwv_flow.g_flow_id,
  p_list_template_current=>t,
  p_list_template_noncurrent=> t2,
...
prompt  ......list template 1619616544901511
...
wwv_flow_api.create_list_template (
  p_id=>1619616544901511 + wwv_flow_api.g_id_offset,
  p_flow_id=>wwv_flow.g_flow_id,
  p_list_template_current=>t,
  p_list_template_noncurrent=> t2,
...
prompt  ......list template 1619700407901511
...
t8 := null;
wwv_flow_api.create_list_template (
  p_id=>1619700407901511 + wwv_flow_api.g_id_offset,
  p_flow_id=>wwv_flow.g_flow_id,
  p_list_template_current=>t,
  p_list_template_noncurrent=> t2,
...
prompt  ......list template 1619820995901512
...
t8 := null;
wwv_flow_api.create_list_template (
  p_id=>1619820995901512 + wwv_flow_api.g_id_offset,
  p_flow_id=>wwv_flow.g_flow_id,
  p_list_template_current=>t,
  p_list_template_noncurrent=> t2,
...
prompt  ......list template 1619910504901512
...
t8 := null;
wwv_flow_api.create_list_template (
  p_id=>1619910504901512 + wwv_flow_api.g_id_offset,
  p_flow_id=>wwv_flow.g_flow_id,
  p_list_template_current=>t,
  p_list_template_noncurrent=> t2,
...
prompt  ......list template 1620002878901512
...
t8 := null;
wwv_flow_api.create_list_template (
  p_id=>1620002878901512 + wwv_flow_api.g_id_offset,
  p_flow_id=>wwv_flow.g_flow_id,
  p_list_template_current=>t,
  p_list_template_noncurrent=> t2,
...
prompt  ......list template 1620105087901512
...
t8 := null;
wwv_flow_api.create_list_template (
  p_id=>1620105087901512 + wwv_flow_api.g_id_offset,
  p_flow_id=>wwv_flow.g_flow_id,
  p_list_template_current=>t,
  p_list_template_noncurrent=> t2,
...
prompt  ......list template 1620219136901512
...
t8 := null;
wwv_flow_api.create_list_template (
  p_id=>1620219136901512 + wwv_flow_api.g_id_offset,
  p_flow_id=>wwv_flow.g_flow_id,
  p_list_template_current=>t,
  p_list_template_noncurrent=> t2,
...
prompt  ......list template 1620332467901512
...
t8 := null;
wwv_flow_api.create_list_template (
  p_id=>1620332467901512 + wwv_flow_api.g_id_offset,
  p_flow_id=>wwv_flow.g_flow_id,
  p_list_template_current=>t,
  p_list_template_noncurrent=> t2,
...
prompt  ......list template 1620432313901513
...
t8 := null;
wwv_flow_api.create_list_template (
  p_id=>1620432313901513 + wwv_flow_api.g_id_offset,
  p_flow_id=>wwv_flow.g_flow_id,
  p_list_template_current=>t,
  p_list_template_noncurrent=> t2,
...
prompt  ......report template 1620516623901513
...
wwv_flow_api.create_row_template (
  p_id=> 1620516623901513 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
...
prompt  ......report template 1620608747901523
...
c4 := null;
wwv_flow_api.create_row_template (
  p_id=> 1620608747901523 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
...
prompt  ......report template 1620711827901523
...
c4 := null;
wwv_flow_api.create_row_template (
  p_id=> 1620711827901523 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
...
prompt  ......report template 1620831781901524
...
c4 := null;
wwv_flow_api.create_row_template (
  p_id=> 1620831781901524 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
...
prompt  ......report template 1620903803901524
...
c4 := null;
wwv_flow_api.create_row_template (
  p_id=> 1620903803901524 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
...
prompt  ......report template 1621024876901524
...
c4 := null;
wwv_flow_api.create_row_template (
  p_id=> 1621024876901524 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
...
prompt  ......report template 1621106426901524
...
c4 := null;
wwv_flow_api.create_row_template (
  p_id=> 1621106426901524 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
...
prompt  ......report template 1621205638901524
...
c4 := null;
wwv_flow_api.create_row_template (
  p_id=> 1621205638901524 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
...
prompt  ......report template 1621321623901524
...
c4 := null;
wwv_flow_api.create_row_template (
  p_id=> 1621321623901524 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
...
prompt  ......label template 1621429016901525
 
begin
 
begin
wwv_flow_api.create_field_template (
  p_id=> 1621429016901525 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
...
prompt  ......label template 1621515626901527
 
begin
 
begin
wwv_flow_api.create_field_template (
  p_id=> 1621515626901527 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
...
prompt  ......label template 1621628637901527
 
begin
 
begin
wwv_flow_api.create_field_template (
  p_id=> 1621628637901527 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
...
prompt  ......label template 1621712877901528
 
begin
 
begin
wwv_flow_api.create_field_template (
  p_id=> 1621712877901528 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
...
prompt  ......label template 1621828958901528
 
begin
 
begin
wwv_flow_api.create_field_template (
  p_id=> 1621828958901528 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
...
prompt  ......template 1621902103901528
 
begin
 
begin
wwv_flow_api.create_menu_template (
  p_id=> 1621902103901528 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
...
prompt  ......template 1622026482901530
 
begin
 
begin
wwv_flow_api.create_menu_template (
  p_id=> 1622026482901530 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
...
--
prompt  ......template 1622710211901535
 
begin
 
begin
wwv_flow_api.create_popup_lov_template (
  p_id=> 1622710211901535 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
...
prompt  ......template 1622117118901530
 
begin
 
begin
wwv_flow_api.create_calendar_template(
  p_id=> 1622117118901530 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
...
prompt  ......template 1622327613901533
 
begin
 
begin
wwv_flow_api.create_calendar_template(
  p_id=> 1622327613901533 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
...
prompt  ......template 1622524094901534
 
begin
 
begin
wwv_flow_api.create_calendar_template(
  p_id=> 1622524094901534 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
...
prompt  ......theme 1622808303901537
begin
wwv_flow_api.create_theme (
  p_id =>1622808303901537 + wwv_flow_api.g_id_offset,
  p_flow_id =>wwv_flow.g_flow_id,
  p_theme_id  => 1,
  ...
  p_login_template=>1614907254901469 + wwv_flow_api.g_id_offset,
  p_default_button_template=>1616409173901483 + wwv_flow_api.g_id_offset,
  p_default_region_template=>1618213075901497 + wwv_flow_api.g_id_offset,
  p_default_chart_template =>1617327708901496 + wwv_flow_api.g_id_offset,
  p_default_form_template  =>1617415723901496 + wwv_flow_api.g_id_offset,
  ...
  p_default_label_template=>1621628637901527 + wwv_flow_api.g_id_offset,
  p_default_menu_template=>1621902103901528 + wwv_flow_api.g_id_offset,
  p_default_calendar_template=>1622117118901530 + wwv_flow_api.g_id_offset,
  p_default_list_template=>1620219136901512 + wwv_flow_api.g_id_offset,
  p_default_option_label=>1621628637901527 + wwv_flow_api.g_id_offset,
  p_default_required_label=>1621828958901528 + wwv_flow_api.g_id_offset);
end;
/
...
prompt  ......scheme 1622903114901580
...
wwv_flow_api.create_auth_setup (
  p_id=> 1622903114901580 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
...
prompt  ......scheme 1623009675901582
...
s5 := null;
wwv_flow_api.create_auth_setup (
  p_id=> 1623009675901582 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_name=> 'DATABASE',
...
prompt  ......scheme 1623102993901582
...
s5 := null;
wwv_flow_api.create_auth_setup (
  p_id=> 1623102993901582 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
