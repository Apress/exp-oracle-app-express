...
prompt  APPLICATION 100 - TABULAR_FORMS
--
-- Application Export:
--   Application:     100
--   Name:            TABULAR_FORMS
--   Date and Time:   22:57 Sunday February 27, 2011
--   Exported By:     ORA_EXPERTS
--   Flashback:       0
...
begin
  ...
  wwv_flow_api.set_security_group_id(p_security_group_id=>nvl(wwv_flow_application_install.get_workspace_id,6792912037181162));
...
wwv_flow_api.create_flow(
  ...
  p_owner => nvl(wwv_flow_application_install.get_schema,'ORA_EXPERTS'),
  p_name  => nvl(wwv_flow_application_install.get_application_name,'TABULAR_FORMS'),
  p_alias => nvl(wwv_flow_application_install.get_application_alias,'F100'),
  p_page_view_logging => 'YES',
  p_default_page_template=> 6804225024205809 + wwv_flow_api.g_id_offset,
  p_printer_friendly_template=> 6804425070205809 + wwv_flow_api.g_id_offset,
  p_default_region_template=> 6806718895205814 + wwv_flow_api.g_id_offset,
  p_error_template=> 6804225024205809 + wwv_flow_api.g_id_offset,
  p_page_protection_enabled_y_n=> 'Y',
  p_checksum_salt_last_reset => '20110227215002',
  ...
  p_cust_authentication_process=> '.'||to_char(6811405880205831 + wwv_flow_api.g_id_offset)||'.',
  ...
  p_theme_id => 1,
  p_default_label_template => 6810105561205817 + wwv_flow_api.g_id_offset,
  p_default_report_template => 6809430354205817 + wwv_flow_api.g_id_offset,
  p_default_list_template => 6808720042205815 + wwv_flow_api.g_id_offset,
  p_default_menu_template => 6810430924205817 + wwv_flow_api.g_id_offset,
  p_default_button_template => 6804931462205814 + wwv_flow_api.g_id_offset,
  p_default_chart_template => 6805816509205814 + wwv_flow_api.g_id_offset,
  p_default_form_template => 6805912803205814 + wwv_flow_api.g_id_offset,
  p_default_wizard_template => 6807329843205814 + wwv_flow_api.g_id_offset,
  p_default_tabform_template => 6806718895205814 + wwv_flow_api.g_id_offset,
  p_default_reportr_template   =>6806718895205814 + wwv_flow_api.g_id_offset,
  p_default_menur_template => 6805502383205814 + wwv_flow_api.g_id_offset,
  p_default_listr_template => 6806118353205814 + wwv_flow_api.g_id_offset,
  p_default_irr_template => 6806418838205814 + wwv_flow_api.g_id_offset,
  p_last_updated_by => 'ORA_EXPERTS',
  p_last_upd_yyyymmddhh24miss=> '20110227215002',
...
wwv_flow_api.create_icon_bar_item(
  p_id => 6811720669205831 + wwv_flow_api.g_id_offset,
...
--
--application/shared_components/logic/application_processes/get_job
...
begin
p:=p||'BEGIN'||chr(10)||
'   tab_form_emp_pkg.get_job;'||chr(10)||
'END;';

wwv_flow_api.create_flow_process(
  p_id => 6863615790960295 + wwv_flow_api.g_id_offset,
  p_flow_id => wwv_flow.g_flow_id,
  p_process_sequence=> 1,
  p_process_point => 'ON_DEMAND',
  p_process_type=> 'PLSQL',
  p_process_name=> 'get_job',
...
--application/shared_components/logic/application_processes/get_manager
...
begin
p:=p||'BEGIN'||chr(10)||
'tab_form_emp_pkg.get_manager;'||chr(10)||
'END;'||chr(10)||
'';

wwv_flow_api.create_flow_process(
  p_id => 6882116179139660 + wwv_flow_api.g_id_offset,
  p_flow_id => wwv_flow.g_flow_id,
  p_process_sequence=> 1,
  p_process_point => 'ON_DEMAND',
  p_process_type=> 'PLSQL',
  p_process_name=> 'get_manager',
  p_process_sql_clob=> p,
  p_process_error_message=> '',
  p_process_when=> '',
  p_process_when_type=> '',
...
--application/shared_components/logic/application_processes/update_emp_coll_member
...
begin
p:=p||'BEGIN'||chr(10)||
'   tab_form_emp_pkg.update_emp_coll_member(:t_col_seq_item,'||chr(10)||
'                                           :t_col_attr_item,'||chr(10)||
'                                           :t_col_val_item);'||chr(10)||
'END;';

wwv_flow_api.create_flow_process(
  p_id => 6932005090173435 + wwv_flow_api.g_id_offset,
  p_flow_id => wwv_flow.g_flow_id,
  p_process_sequence=> 1,
  p_process_point => 'ON_DEMAND',
  p_process_type=> 'PLSQL',
  p_process_name=> 'update_emp_coll_member',
  p_process_sql_clob=> p,
  p_process_error_message=> '',
  p_process_when=> '',
  p_process_when_type=> '',
...
wwv_flow_api.create_flow_item(
  p_id=> 6828904877688440 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
...
--application/shared_components/logic/application_items/t_col_attr_item
 
begin
 
wwv_flow_api.create_flow_item(
  p_id=> 6930706542653426 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_name=> 'T_COL_ATTR_ITEM',
  p_data_type=> 'VARCHAR',
  p_is_persistent=> 'Y',
...
--application/shared_components/logic/application_items/t_col_seq_item
 
begin
 
wwv_flow_api.create_flow_item(
  p_id=> 6930502732652340 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_name=> 'T_COL_SEQ_ITEM',
  p_data_type=> 'VARCHAR',
  p_is_persistent=> 'Y',
  p_protection_level=> 'N',
  p_item_comment=> '');
...
--application/shared_components/logic/application_items/t_col_val_item
 
begin
 
wwv_flow_api.create_flow_item(
  p_id=> 6930331345651175 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_name=> 'T_COL_VAL_ITEM',
  p_data_type=> 'VARCHAR',
  p_is_persistent=> 'Y',
  p_protection_level=> 'N',
  p_item_comment=> '');
...
--application/shared_components/logic/application_items/t_message
 
begin
 
wwv_flow_api.create_flow_item(
  p_id=> 6840117355230573 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_name=> 'T_MESSAGE',
  p_data_type=> 'VARCHAR',
  p_is_persistent=> 'Y',
...
--application/shared_components/navigation/tabs/standard/t_tabular_form_1
wwv_flow_api.create_tab (
  p_id=> 6813109422205837 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_tab_set=> 'TS1',
  p_tab_sequence=> 10,
  p_tab_name=> 'T_TABULAR_FORM_1',
  p_tab_text => 'Tabular Form 1',
  p_tab_step => 1,
  p_tab_also_current_for_pages => '',
  p_tab_parent_tabset=>'',
  p_tab_comment  => '');
 
--application/shared_components/navigation/tabs/standard/t_tabular_form_2
wwv_flow_api.create_tab (
  p_id=> 6896700262407262 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_tab_set=> 'TS1',
  p_tab_sequence=> 15,
  p_tab_name=> 'T_TABULAR FORM 2',
  p_tab_text => 'Tabular Form 2',
  p_tab_step => 2,
  p_tab_also_current_for_pages => '',
  p_tab_parent_tabset=>'',
  p_tab_comment  => '');
 
--application/shared_components/navigation/tabs/standard/t_tabular_form_3
wwv_flow_api.create_tab (
  p_id=> 6886705226699590 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_tab_set=> 'TS1',
  p_tab_sequence=> 20,
  p_tab_name=> 'T_TABULAR FORM 3',
  p_tab_text => 'Tabular Form 3',
  p_tab_step => 3,
  p_tab_also_current_for_pages => '',
  p_tab_parent_tabset=>'',
  p_tab_comment  => '');
 
--application/shared_components/navigation/tabs/standard/t_tabular_form_4
wwv_flow_api.create_tab (
  p_id=> 6909826172410148 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_tab_set=> 'TS1',
  p_tab_sequence=> 30,
  p_tab_name=> 'T_TABULAR FORM 4',
  p_tab_text => 'Tabular Form 4',
  p_tab_step => 4,
  p_tab_also_current_for_pages => '',
  p_tab_parent_tabset=>'',
  p_tab_comment  => '');
...
wwv_flow_api.create_page (
 ...
 ,p_id => 1
 ,p_tab_set => 'TS1'
 ,p_name => 'Tabular Form 1'
 ,p_step_title => 'Tabular Form 1'
 ,p_allow_duplicate_submissions => 'Y'
 ,p_step_sub_title => 'Tabular Form 1'
 ,p_step_sub_title_type => 'TEXT_WITH_SUBSTITUTIONS'
 ,p_first_item => 'AUTO_FIRST_ITEM'
 ,p_include_apex_css_js_yn => 'Y'
 ,p_autocomplete_on_off => 'ON'
 ,p_html_page_header => 
'<script type="text/javascript" src="#WORKSPACE_IMAGES#jquery.autocompleteApex1.2.js"></script>'||chr(10)||
''||chr(10)||
''
 ,p_javascript_code => 
...
'No help is available for this page.'
 ,p_last_updated_by => 'ORA_EXPERTS'
 ,p_last_upd_yyyymmddhh24miss => '20110225231542'
  );
null;
...
wwv_flow_api.create_page_plug (
  p_id=> 6813421215205839 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_page_id=> 1,
  p_plug_name=> 'Breadcrumbs',
  p_region_name=>'',
  p_plug_template=> 6805502383205814+ wwv_flow_api.g_id_offset,
  p_plug_display_sequence=> 1,
  p_plug_display_column=> 1,
  p_plug_display_point=> 'REGION_POSITION_01',
  p_plug_source=> s,
  p_plug_source_type=> 'M'|| to_char(6812821242205835 + wwv_flow_api.g_id_offset),
  p_menu_template_id=> 6810430924205817+ wwv_flow_api.g_id_offset,
...
declare
  ...
  l_length number := 1;
begin
s:=s||'SELECT empno, '||chr(10)||
'          empno'||chr(10)||
'       || tab_form_emp_pkg.get_autocomplete (''f04'', ''#ROWNUM#'', 85, ''get_job'') empno_display,'||chr(10)||
'       ename, job,'||chr(10)||
'       tab_form_emp_pkg.get_autocomplete_key'||chr(10)||
'                        (tab_form_emp_pkg.get_manager_for_id (mgr),'||chr(10)||
'                         ''f05'','||chr(10)||
'                         ''#ROWNUM#'','||chr(10)||
'                         85,'||chr(10)||
'                         ''get_manager'''||chr(10)||
...
s:=s||'                  ) mgr_search,'||chr(10)||
'       mgr, hiredate, sal, comm, deptno, valid'||chr(10)||
'  FROM emp'||chr(10)||
'';

wwv_flow_api.create_report_region (
  p_id=> 6833202311652870 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_page_id=> 1,
  p_name=> 'Tabular Form on EMP Table',
  p_region_name=>'',
  p_template=> 6806718895205814+ wwv_flow_api.g_id_offset,
  ...
  p_translate_title=> 'Y',
  p_ajax_enabled=> 'N',
  p_query_row_template=> 6809430354205817+ wwv_flow_api.g_id_offset,
...
wwv_flow_api.create_report_columns (
  p_id=> 6837120851652875 + wwv_flow_api.g_id_offset,
  p_region_id=> 6833202311652870 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_query_column_id=> 1,
...
s := null;
wwv_flow_api.create_report_columns (
  p_id=> 6833500551652870 + wwv_flow_api.g_id_offset,
  p_region_id=> 6833202311652870 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_query_column_id=> 2,
  p_form_element_id=> null,
...
s := null;
wwv_flow_api.create_report_columns (
  p_id=> 6833607824652870 + wwv_flow_api.g_id_offset,
  p_region_id=> 6833202311652870 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_query_column_id=> 3,
  p_form_element_id=> null,
...
s := null;
wwv_flow_api.create_report_columns (
  p_id=> 6833720803652870 + wwv_flow_api.g_id_offset,
  p_region_id=> 6833202311652870 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_query_column_id=> 4,
  p_form_element_id=> null,
...
s := null;
wwv_flow_api.create_report_columns (
  p_id=> 6833814009652870 + wwv_flow_api.g_id_offset,
  p_region_id=> 6833202311652870 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_query_column_id=> 5,
  p_form_element_id=> null,
  ...
  p_column_html_expression=>'<input type="text" id="f04_#ROWNUM#" value="#JOB#" maxlength="2000" size="12" name="f04" autocomplete="off" class="ac_input">',
  p_column_alignment=>'LEFT',
  p_heading_alignment=>'LEFT',
  p_default_sort_column_sequence=>0,
  p_disable_sort_column=>'N',
  ...
  p_lov_show_nulls=> 'NO',
  p_column_width=> '12',
  p_cattributes_element=> 'autocomplete="off"',
  p_is_required=> false,
  p_lov_display_extra=> 'YES',
  p_include_in_export=> 'Y',
  p_ref_schema=> 'ORA_EXPERTS',
...
s := null;
wwv_flow_api.create_report_columns (
  p_id=> 6881915153135067 + wwv_flow_api.g_id_offset,
  p_region_id=> 6833202311652870 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_query_column_id=> 6,
  p_form_element_id=> null,
  p_column_alias=> 'MGR_SEARCH',
  p_column_display_sequence=> 6,
  p_column_heading=> 'Mgr Search',
  p_column_alignment=>'LEFT',
  p_heading_alignment=>'CENTER',
  p_default_sort_column_sequence=>0,
  p_disable_sort_column=>'Y',
...
s := null;
wwv_flow_api.create_report_columns (
  p_id=> 6833915850652870 + wwv_flow_api.g_id_offset,
  p_region_id=> 6833202311652870 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_query_column_id=> 7,
  p_form_element_id=> null,
  ...
  p_column_heading=> '',
  p_column_html_expression=>'<input type="hidden" id="f05_#ROWNUM#" value="#MGR#" maxlength="2000" size="16" name="f05" autocomplete="off">',
  p_column_alignment=>'LEFT',
  p_heading_alignment=>'LEFT',
  p_default_sort_column_sequence=>0,
  p_disable_sort_column=>'N',
...
s := null;
wwv_flow_api.create_report_columns (
  p_id=> 6834000562652871 + wwv_flow_api.g_id_offset,
  p_region_id=> 6833202311652870 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_query_column_id=> 8,
  p_form_element_id=> null,
...
s := null;
wwv_flow_api.create_report_columns (
  p_id=> 6834115216652871 + wwv_flow_api.g_id_offset,
  p_region_id=> 6833202311652870 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_query_column_id=> 9,
  p_form_element_id=> null,
...
s := null;
wwv_flow_api.create_report_columns (
  p_id=> 6834212548652871 + wwv_flow_api.g_id_offset,
  p_region_id=> 6833202311652870 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
...
s := null;
wwv_flow_api.create_report_columns (
  p_id=> 6834328575652871 + wwv_flow_api.g_id_offset,
  p_region_id=> 6833202311652870 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  ...
  p_inline_lov=> 'SELECT dname d, deptno r'||chr(10)||
'  FROM dept'||chr(10)||
'',
  p_lov_show_nulls=> 'NO',
  p_column_width=> '16',
...
s := null;
wwv_flow_api.create_report_columns (
  p_id=> 6834428260652871 + wwv_flow_api.g_id_offset,
  p_region_id=> 6833202311652870 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_query_column_id=> 12,
  p_form_element_id=> null,
  p_column_alias=> 'VALID',
...
wwv_flow_api.create_page_button(
  p_id             => 6834829409652871 + wwv_flow_api.g_id_offset,
  p_flow_id        => wwv_flow.g_flow_id,
  p_flow_step_id   => 1,
  p_button_sequence=> 40,
  p_button_plug_id => 6833202311652870+wwv_flow_api.g_id_offset,
  p_button_name    => 'ADD',
  p_button_image   => 'template:'||to_char(6804931462205814+wwv_flow_api.g_id_offset),
...
wwv_flow_api.create_page_button(
  p_id             => 6834623913652871 + wwv_flow_api.g_id_offset,
  p_flow_id        => wwv_flow.g_flow_id,
  p_flow_step_id   => 1,
...
wwv_flow_api.create_page_button(
  p_id             => 6834520986652871 + wwv_flow_api.g_id_offset,
  p_flow_id        => wwv_flow.g_flow_id,
  p_flow_step_id   => 1,
...
wwv_flow_api.create_page_button(
  p_id             => 6834723830652871 + wwv_flow_api.g_id_offset,
  p_flow_id        => wwv_flow.g_flow_id,
  p_flow_step_id   => 1,
...
wwv_flow_api.create_page_branch(
  p_id=>6837220728652875 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_flow_step_id=> 1,
...
wwv_flow_api.create_page_validation(
  p_id => 6845225064740215 + wwv_flow_api.g_id_offset,
  p_flow_id => wwv_flow.g_flow_id,
  p_flow_step_id => 1,
  p_tabular_form_region_id => null + wwv_flow_api.g_id_offset,
  p_validation_name => 'Check Data Integrity',
  p_validation_sequence=> 1,
  p_validation => 'BEGIN'||chr(10)||
'   RETURN tab_form_emp_pkg.validate_data_integrity;'||chr(10)||
'END;',
...
wwv_flow_api.create_page_validation(
  p_id => 6835616453652873 + wwv_flow_api.g_id_offset,
  p_flow_id => wwv_flow.g_flow_id,
  p_flow_step_id => 1,
  p_tabular_form_region_id => 6833202311652870 + wwv_flow_api.g_id_offset,
  p_validation_name => 'ENAME not null',
  p_validation_sequence=> 30,
  p_validation => 'ENAME',
  p_validation_type => 'COL_NOT_NULL',
  p_error_message => '#COLUMN_HEADER# must have a value.',
  p_when_button_pressed=> 6834623913652871 + wwv_flow_api.g_id_offset,
...
wwv_flow_api.create_page_validation(
  p_id => 6835803571652873 + wwv_flow_api.g_id_offset,
  p_flow_id => wwv_flow.g_flow_id,
  p_flow_step_id => 1,
  p_tabular_form_region_id => 6833202311652870 + wwv_flow_api.g_id_offset,
...
wwv_flow_api.create_page_validation(
  p_id => 6836005642652873 + wwv_flow_api.g_id_offset,
  p_flow_id => wwv_flow.g_flow_id,
  p_flow_step_id => 1,
  p_tabular_form_region_id => 6833202311652870 + wwv_flow_api.g_id_offset,
...
wwv_flow_api.create_page_validation(
  p_id => 6836219553652873 + wwv_flow_api.g_id_offset,
  p_flow_id => wwv_flow.g_flow_id,
  p_flow_step_id => 1,
  p_tabular_form_region_id => 6833202311652870 + wwv_flow_api.g_id_offset,
...
wwv_flow_api.create_page_validation(
  p_id => 6836418446652875 + wwv_flow_api.g_id_offset,
  p_flow_id => wwv_flow.g_flow_id,
  p_flow_step_id => 1,
  p_tabular_form_region_id => 6833202311652870 + wwv_flow_api.g_id_offset,
...
wwv_flow_api.create_page_validation(
  p_id => 6836606259652875 + wwv_flow_api.g_id_offset,
  p_flow_id => wwv_flow.g_flow_id,
  p_flow_step_id => 1,
  p_tabular_form_region_id => 6833202311652870 + wwv_flow_api.g_id_offset,
...
wwv_flow_api.create_page_process(
  p_id     => 6836702955652875 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_flow_step_id => 1,
  ...
  p_process_when_button_id=>6834623913652871 + wwv_flow_api.g_id_offset,
...
wwv_flow_api.create_page_process(
  p_id     => 6836909722652875 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_flow_step_id => 1,
...
begin
p:=p||'BEGIN'||chr(10)||
'   tab_form_emp_pkg.disable_foreign_constraints;'||chr(10)||
'   tab_form_emp_pkg.delete_emp_row (:t_message);'||chr(10)||
'END;';

wwv_flow_api.create_page_process(
  p_id     => 6840302257311370 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_flow_step_id => 1,
  p_process_sequence=> 30,
  p_process_point=> 'AFTER_SUBMIT',
  p_process_type=> 'PLSQL',
  p_process_name=> 'ApplyMRD Manual',
  p_process_sql_clob => p, 
  p_process_error_message=> '',
  p_process_when=>':REQUEST IN (''MULTI_ROW_DELETE'')',
  p_process_when_type=>'PLSQL_EXPRESSION',
  p_process_success_message=> '&T_MESSAGE.',
  p_process_is_stateful_y_n=>'N',
  p_process_comment=>'');
end;
null;
...
wwv_flow_api.create_region_rpt_cols (
  p_id     => 6840816043835703 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_plug_id=> 6833202311652870 + wwv_flow_api.g_id_offset,
  p_column_sequence=> 1,
...
wwv_flow_api.create_region_rpt_cols (
  p_id     => 6840903985835706 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_plug_id=> 6833202311652870 + wwv_flow_api.g_id_offset,
  p_column_sequence=> 2,
  p_query_column_name=> 'EMPNO_DISPLAY',
  p_display_as=> 'TEXT',
  p_column_comment=> '');
 
wwv_flow_api.create_region_rpt_cols (
  p_id     => 6841008120835706 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_plug_id=> 6833202311652870 + wwv_flow_api.g_id_offset,
  p_column_sequence=> 3,
...
wwv_flow_api.create_region_rpt_cols (
  p_id     => 6841108494835706 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_plug_id=> 6833202311652870 + wwv_flow_api.g_id_offset,
  p_column_sequence=> 4,
...
wwv_flow_api.create_region_rpt_cols (
  p_id     => 6881201214135065 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_plug_id=> 6833202311652870 + wwv_flow_api.g_id_offset,
  p_column_sequence=> 5,
  p_query_column_name=> 'MGR_SEARCH',
  p_display_as=> 'TEXT',
  p_column_comment=> '');
 
wwv_flow_api.create_region_rpt_cols (
  p_id     => 6841229262835706 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_plug_id=> 6833202311652870 + wwv_flow_api.g_id_offset,
  p_column_sequence=> 6,
...
wwv_flow_api.create_region_rpt_cols (
  p_id     => 6841327385835706 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_plug_id=> 6833202311652870 + wwv_flow_api.g_id_offset,
  p_column_sequence=> 7,
...
wwv_flow_api.create_region_rpt_cols (
  p_id     => 6841425688835706 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_plug_id=> 6833202311652870 + wwv_flow_api.g_id_offset,
  p_column_sequence=> 8,
...
wwv_flow_api.create_region_rpt_cols (
  p_id     => 6841501996835706 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_plug_id=> 6833202311652870 + wwv_flow_api.g_id_offset,
  p_column_sequence=> 9,
...
wwv_flow_api.create_region_rpt_cols (
  p_id     => 6841614161835706 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_plug_id=> 6833202311652870 + wwv_flow_api.g_id_offset,
...
wwv_flow_api.create_region_rpt_cols (
  p_id     => 6841715149835706 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_plug_id=> 6833202311652870 + wwv_flow_api.g_id_offset,
  p_column_sequence=> 11,
  p_query_column_name=> 'VALID',
  p_display_as=> 'TEXT',
  p_column_comment=> '');
...
wwv_flow_api.create_page (
 ...
 ,p_id => 2
 ,p_tab_set => 'TS1'
 ,p_name => 'Tabular Form 2'
 ,p_step_title => 'Tabular Form 2'
 ,p_allow_duplicate_submissions => 'Y'
 ,p_step_sub_title => 'Tabular Form 2'
 ,p_step_sub_title_type => 'TEXT_WITH_SUBSTITUTIONS'
 ,p_first_item => 'AUTO_FIRST_ITEM'
 ,p_include_apex_css_js_yn => 'Y'
 ,p_autocomplete_on_off => 'ON'
...
'No help is available for this page.'
 ,p_last_updated_by => 'ORA_EXPERTS'
 ,p_last_upd_yyyymmddhh24miss => '20110226104438'
  );
null;
...
s := null;
wwv_flow_api.create_page_plug (
  p_id=> 6899121410407265 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_page_id=> 2,
  p_plug_name=> 'Breadcrumbs',
  p_region_name=>'',
...
declare
  ...
  l_length number := 1;
begin
s:=s||'SELECT apex_item.checkbox (1, ''#ROWNUM#'') empno,'||chr(10)||
'       apex_item.hidden (2, empno) || apex_item.text (3, ename, 20, 20) ename,'||chr(10)||
'       apex_item.text (4, job, 10, 10) job, apex_item.text (5, mgr, 5, 5) mgr,'||chr(10)||
'       apex_item.text (6, hiredate, 12, 12) hiredate,'||chr(10)||
'       apex_item.text (7, sal, 6, 6) sal, apex_item.text (8, comm, 6, 6) comm,'||chr(10)||
'          apex_item.text (9, deptno, 4, 4)'||chr(10)||
'       || apex_it';

s:=s||'em.hidden (10, checksum) deptno'||chr(10)||
'  FROM (SELECT NULL empno, NULL ename, NULL job, NULL mgr, NULL hiredate,'||chr(10)||
'               NULL sal, NULL comm, NULL deptno, NULL checksum'||chr(10)||
'          FROM DUAL'||chr(10)||
'         WHERE :request IN (''ADD'')'||chr(10)||
'        UNION ALL'||chr(10)||
'        SELECT empno, ename, job, mgr, hiredate, sal, comm, deptno,'||chr(10)||
'               wwv_flow_item.md5 (empno,'||chr(10)||
'                                  ename,'||chr(10)||
'        ';
...
wwv_flow_api.create_report_region (
  p_id=> 6903424220414970 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_page_id=> 2,
  p_name=> 'Tabular Form on EMP Table',
  p_region_name=>'',
...
s := null;
wwv_flow_api.create_report_columns (
  p_id=> 6903719236414971 + wwv_flow_api.g_id_offset,
  p_region_id=> 6903424220414970 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_query_column_id=> 1,
  p_form_element_id=> null,
  p_column_alias=> 'EMPNO',
...
s := null;
wwv_flow_api.create_report_columns (
  p_id=> 6903816657414971 + wwv_flow_api.g_id_offset,
  p_region_id=> 6903424220414970 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_query_column_id=> 2,
  p_form_element_id=> null,
...
s := null;
wwv_flow_api.create_report_columns (
  p_id=> 6903924152414971 + wwv_flow_api.g_id_offset,
  p_region_id=> 6903424220414970 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_query_column_id=> 3,
  p_form_element_id=> null,
...
s := null;
wwv_flow_api.create_report_columns (
  p_id=> 6904030005414971 + wwv_flow_api.g_id_offset,
  p_region_id=> 6903424220414970 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_query_column_id=> 4,
  p_form_element_id=> null,
...
s := null;
wwv_flow_api.create_report_columns (
  p_id=> 6904127942414971 + wwv_flow_api.g_id_offset,
  p_region_id=> 6903424220414970 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_query_column_id=> 5,
  p_form_element_id=> null,
...
s := null;
wwv_flow_api.create_report_columns (
  p_id=> 6904230356414973 + wwv_flow_api.g_id_offset,
  p_region_id=> 6903424220414970 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_query_column_id=> 6,
  p_form_element_id=> null,
...
s := null;
wwv_flow_api.create_report_columns (
  p_id=> 6904310255414973 + wwv_flow_api.g_id_offset,
  p_region_id=> 6903424220414970 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_query_column_id=> 7,
  p_form_element_id=> null,
...
s := null;
wwv_flow_api.create_report_columns (
  p_id=> 6904408377414973 + wwv_flow_api.g_id_offset,
  p_region_id=> 6903424220414970 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_query_column_id=> 8,
  p_form_element_id=> null,
...
wwv_flow_api.create_page_button(
  p_id             => 6898914423407265 + wwv_flow_api.g_id_offset,
  p_flow_id        => wwv_flow.g_flow_id,
  p_flow_step_id   => 2,
  p_button_sequence=> 40,
  p_button_plug_id => 6903424220414970+wwv_flow_api.g_id_offset,
  p_button_name    => 'ADD',
  p_button_image   => 'template:'||to_char(6804931462205814+wwv_flow_api.g_id_offset),
  p_button_image_alt=> 'Add Row',
  p_button_position=> 'BOTTOM',
...
wwv_flow_api.create_page_button(
  p_id             => 6898321479407264 + wwv_flow_api.g_id_offset,
  p_flow_id        => wwv_flow.g_flow_id,
  p_flow_step_id   => 2,
  p_button_sequence=> 30,
  p_button_plug_id => 6903424220414970+wwv_flow_api.g_id_offset,
...
wwv_flow_api.create_page_button(
  p_id             => 6898501050407264 + wwv_flow_api.g_id_offset,
  p_flow_id        => wwv_flow.g_flow_id,
  p_flow_step_id   => 2,
  p_button_sequence=> 10,
  p_button_plug_id => 6903424220414970+wwv_flow_api.g_id_offset,
...
wwv_flow_api.create_page_button(
  p_id             => 6898704918407264 + wwv_flow_api.g_id_offset,
  p_flow_id        => wwv_flow.g_flow_id,
  p_flow_step_id   => 2,
  p_button_sequence=> 20,
  p_button_plug_id => 6903424220414970+wwv_flow_api.g_id_offset,
...
wwv_flow_api.create_page_branch(
  p_id=>6907021945575156 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_flow_step_id=> 2,
  p_branch_action=> 'f?p=&APP_ID.:2:&SESSION.:ADD:&DEBUG.:::&success_msg=#SUCCESS_MSG#',
  p_branch_point=> 'AFTER_PROCESSING',
  p_branch_type=> 'REDIRECT_URL',
  p_branch_when_button_id=>6898914423407265+ wwv_flow_api.g_id_offset,
  p_branch_sequence=> 5,
  p_save_state_before_branch_yn=>'Y',
  p_branch_comment=> 'Created 26-FEB-2011 09:57 by ORA_EXPERTS');
 
wwv_flow_api.create_page_branch(
  p_id=>6901421342407268 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_flow_step_id=> 2,
...
wwv_flow_api.create_page_validation(
  p_id => 6908403366853648 + wwv_flow_api.g_id_offset,
  p_flow_id => wwv_flow.g_flow_id,
  p_flow_step_id => 2,
  p_tabular_form_region_id => null + wwv_flow_api.g_id_offset,
  p_validation_name => 'Validate Commission',
  p_validation_sequence=> 10,
  p_validation => 'BEGIN'||chr(10)||
'   RETURN tab_form_emp_pkg.validate_emp_comm;'||chr(10)||
'END;',
  p_validation_type => 'FUNC_BODY_RETURNING_ERR_TEXT',
  p_error_message => '',
  p_always_execute=>'N',
...
begin
p:=p||'BEGIN'||chr(10)||
'   tab_form_emp_pkg.save_emp_custom (:t_message);'||chr(10)||
'END;';

wwv_flow_api.create_page_process(
  p_id     => 6907813905667459 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_flow_step_id => 2,
  p_process_sequence=> 10,
  p_process_point=> 'AFTER_SUBMIT',
  p_process_type=> 'PLSQL',
  p_process_name=> 'ApplyMRU Manual',
  p_process_sql_clob => p, 
  p_process_error_message=> '',
  p_process_when=>':REQUEST IN (''ADD'', ''SUBMIT'')',
  p_process_when_type=>'PLSQL_EXPRESSION',
  p_process_success_message=> '&T_MESSAGE.',
  p_process_is_stateful_y_n=>'N',
  p_process_comment=>'');
...
wwv_flow_api.create_page_process(
  p_id     => 6907623817660834 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_flow_step_id => 2,
...
wwv_flow_api.create_page (
 ...
 ,p_id => 3
 ,p_tab_set => 'TS1'
 ,p_name => 'Tabular Form 3'
 ,p_step_title => 'Tabular Form 3'
 ,p_allow_duplicate_submissions => 'Y'
 ,p_step_sub_title => 'Tabular Form 3'
 ,p_step_sub_title_type => 'TEXT_WITH_SUBSTITUTIONS'
 ,p_first_item => 'AUTO_FIRST_ITEM'
 ,p_include_apex_css_js_yn => 'Y'
 ,p_autocomplete_on_off => 'ON'
...
' function LPad(ContentToSize,PadLength,PadChar)'||chr(10)||
'  {'||chr(10)||
'     var PaddedString=ContentToSize.toString();'||chr(10)||
'     for(i=ContentToSize.length+1;i<=PadLength;i++)'||chr(10)||
'     {PaddedString=PadChar+PaddedString;}'||chr(10)||
'     return PaddedString;'||chr(10)||
'  }'||chr(10)||
''||chr(10)||
' function f_update_emp_coll_member(pThis,pRownum,pAttribNo){ '||chr(10)||
'    var v_seq_array = ''f02_'' + LPad(pRownum, 4, "0");'||chr(10)||
'    v'||
'ar SeqID =  $x(v_seq_array).value;'||chr(10)||
'    var get = new htmldb_Get(null,$x(''pFlowId'').value,'||chr(10)||
'              ''APPLICATION_PROCESS=update_emp_coll_member'',0);'||chr(10)||
'    get.add(''T_COL_VAL_ITEM'',pThis);'||chr(10)||
'    get.add(''T_COL_SEQ_ITEM'',SeqID);'||chr(10)||
'    get.add(''T_COL_ATTR_ITEM'',pAttribNo);'||chr(10)||
'    gReturn = get.get();'||chr(10)||
'    if(gReturn) {alert(gReturn)}'||chr(10)||
'    get = null;'||chr(10)||
' }'||chr(10)||
'</script>'||chr(10)||
''
...
s := null;
wwv_flow_api.create_page_plug (
  p_id=> 6889210304699595 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_page_id=> 3,
  p_plug_name=> 'Breadcrumbs',
  p_region_name=>'',
...
'"SEQ_ID",'||chr(10)||
'"EMPNO",'||chr(10)||
'"SEQ_ID" SEQ_ID_DISPLAY,'||chr(10)||
'"EMPNO" EMPNO_DISPLAY,'||chr(10)||
'"ENAME",'||chr(10)||
'"JOB",'||chr(10)||
'"MGR",'||chr(10)||
'"HIREDATE",'||chr(10)||
...
'"CHECKSUM",'||chr(10)||
'"DELETE_FLAG"'||chr(10)||
'from "#OWNER#"."EMP_COLL_V"'||chr(10)||
'WHERE DELETE_FLAG IS NULL'||chr(10)||
'';

wwv_flow_api.create_report_region (
  p_id=> 6922807724288279 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_page_id=> 3,
  p_name=> 'Tabular Form Collection',
  p_region_name=>'',
  p_template=> 6806718895205814+ wwv_flow_api.g_id_offset,
  p_display_sequence=> 15,
  p_display_column=> 1,
...
s := null;
wwv_flow_api.create_report_columns (
  p_id=> 6925916179288289 + wwv_flow_api.g_id_offset,
  p_region_id=> 6922807724288279 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_query_column_id=> 1,
  p_form_element_id=> null,
  p_column_alias=> 'CHECK$01',
...
s := null;
wwv_flow_api.create_report_columns (
  p_id=> 6923102939288281 + wwv_flow_api.g_id_offset,
  p_region_id=> 6922807724288279 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_query_column_id=> 2,
  p_form_element_id=> null,
  ...
  p_pk_col_source_type=> 'T',
  p_ref_schema=> 'ORA_EXPERTS',
  p_ref_table_name=> 'EMP_COLL_V',
  p_ref_column_name=> 'SEQ_ID',
  p_column_comment=>'');
end;
/
declare
...
s := null;
wwv_flow_api.create_report_columns (
  p_id=> 6923213881288281 + wwv_flow_api.g_id_offset,
  p_region_id=> 6922807724288279 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_query_column_id=> 3,
  p_form_element_id=> null,
...
s := null;
wwv_flow_api.create_report_columns (
  p_id=> 6923307264288281 + wwv_flow_api.g_id_offset,
  p_region_id=> 6922807724288279 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_query_column_id=> 4,
  p_form_element_id=> null,
  ...
  p_ref_schema=> 'ORA_EXPERTS',
  p_ref_table_name=> 'EMP_COLL_V',
  p_ref_column_name=> 'SEQ_ID_DISPLAY',
  p_column_comment=>'');
end;
/
declare
...
s := null;
wwv_flow_api.create_report_columns (
  p_id=> 6923414857288281 + wwv_flow_api.g_id_offset,
  p_region_id=> 6922807724288279 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_query_column_id=> 5,
  p_form_element_id=> null,
...
s := null;
wwv_flow_api.create_report_columns (
  p_id=> 6923519923288281 + wwv_flow_api.g_id_offset,
  p_region_id=> 6922807724288279 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_query_column_id=> 6,
  p_form_element_id=> null,
  ...
  p_lov_show_nulls=> 'NO',
  p_column_width=> '16',
  p_cattributes=> 'onchange="f_update_emp_coll_member(this.value,''#ROWNUM#'',2);"',
  p_is_required=> false,
  p_lov_display_extra=> 'YES',
  p_include_in_export=> 'Y',
  p_ref_schema=> 'ORA_EXPERTS',
...
s := null;
wwv_flow_api.create_report_columns (
  p_id=> 6923601866288281 + wwv_flow_api.g_id_offset,
  p_region_id=> 6922807724288279 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_query_column_id=> 7,
  p_form_element_id=> null,
  ...
  p_lov_show_nulls=> 'NO',
  p_column_width=> '16',
  p_cattributes=> 'onchange="f_update_emp_coll_member(this.value,''#ROWNUM#'',3);"',
  p_is_required=> false,
  p_lov_display_extra=> 'YES',
  p_include_in_export=> 'Y',
  p_ref_schema=> 'ORA_EXPERTS',
...
s := null;
wwv_flow_api.create_report_columns (
  p_id=> 6923731370288281 + wwv_flow_api.g_id_offset,
  p_region_id=> 6922807724288279 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_query_column_id=> 8,
  p_form_element_id=> null,
  ...
  p_lov_show_nulls=> 'NO',
  p_column_width=> '16',
  p_cattributes=> 'onchange="f_update_emp_coll_member(this.value,''#ROWNUM#'',4);"',
  p_is_required=> false,
  p_lov_display_extra=> 'YES',
  p_include_in_export=> 'Y',
  p_ref_schema=> 'ORA_EXPERTS',
...
s := null;
wwv_flow_api.create_report_columns (
  p_id=> 6923812527288281 + wwv_flow_api.g_id_offset,
  p_region_id=> 6922807724288279 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_query_column_id=> 9,
  p_form_element_id=> null,
  ...
  p_lov_show_nulls=> 'NO',
  p_column_width=> '16',
  p_cattributes=> 'onchange="f_update_emp_coll_member(this.value,''#ROWNUM#'',5);"',
  p_is_required=> false,
  p_lov_display_extra=> 'YES',
  p_include_in_export=> 'Y',
  p_ref_schema=> 'ORA_EXPERTS',
...
s := null;
wwv_flow_api.create_report_columns (
  p_id=> 6923914714288281 + wwv_flow_api.g_id_offset,
  p_region_id=> 6922807724288279 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_query_column_id=> 10,
  p_form_element_id=> null,
  ...
  p_lov_show_nulls=> 'NO',
  p_column_width=> '16',
  p_cattributes=> 'onchange="f_update_emp_coll_member(this.value,''#ROWNUM#'',6);"',
  p_is_required=> false,
  p_lov_display_extra=> 'YES',
  p_include_in_export=> 'Y',
  p_ref_schema=> 'ORA_EXPERTS',
...
s := null;
wwv_flow_api.create_report_columns (
  p_id=> 6924026851288281 + wwv_flow_api.g_id_offset,
  p_region_id=> 6922807724288279 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_query_column_id=> 11,
  p_form_element_id=> null,
  ...
  p_lov_show_nulls=> 'NO',
  p_column_width=> '16',
  p_cattributes=> 'onchange="f_update_emp_coll_member(this.value,''#ROWNUM#'',7);"',
  p_is_required=> false,
  p_lov_display_extra=> 'YES',
  p_include_in_export=> 'Y',
  p_ref_schema=> 'ORA_EXPERTS',
...
s := null;
wwv_flow_api.create_report_columns (
  p_id=> 6924100965288281 + wwv_flow_api.g_id_offset,
  p_region_id=> 6922807724288279 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_query_column_id=> 12,
  p_form_element_id=> null,
  ...
  p_lov_show_nulls=> 'NO',
  p_column_width=> '16',
  p_cattributes=> 'onchange="f_update_emp_coll_member(this.value,''#ROWNUM#'',8);"',
  p_is_required=> false,
  p_lov_display_extra=> 'YES',
  p_include_in_export=> 'Y',
  p_ref_schema=> 'ORA_EXPERTS',
...
s := null;
wwv_flow_api.create_report_columns (
  p_id=> 6924212526288281 + wwv_flow_api.g_id_offset,
  p_region_id=> 6922807724288279 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  ...
  p_lov_show_nulls=> 'NO',
  p_column_width=> '16',
  p_cattributes=> 'onchange="f_update_emp_coll_member(this.value,''#ROWNUM#'',9);"',
  p_is_required=> false,
  p_lov_display_extra=> 'YES',
  p_include_in_export=> 'Y',
  p_ref_schema=> 'ORA_EXPERTS',
...
s := null;
wwv_flow_api.create_report_columns (
  p_id=> 6924312362288281 + wwv_flow_api.g_id_offset,
  p_region_id=> 6922807724288279 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
...
s := null;
wwv_flow_api.create_report_columns (
  p_id=> 6924421491288281 + wwv_flow_api.g_id_offset,
  p_region_id=> 6922807724288279 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_query_column_id=> 15,
  p_form_element_id=> null,
  p_column_alias=> 'DELETE_FLAG',
  p_column_display_sequence=> 15,
  p_column_heading=> 'Delete Flag',
  p_column_alignment=>'LEFT',
  p_heading_alignment=>'LEFT',
  p_default_sort_column_sequence=>0,
  p_disable_sort_column=>'N',
...
wwv_flow_api.create_page_button(
  p_id             => 6924832204288284 + wwv_flow_api.g_id_offset,
  p_flow_id        => wwv_flow.g_flow_id,
  p_flow_step_id   => 3,
  p_button_sequence=> 40,
  p_button_plug_id => 6922807724288279+wwv_flow_api.g_id_offset,
  p_button_name    => 'ADD',
  p_button_image   => 'template:'||to_char(6804931462205814+wwv_flow_api.g_id_offset),
  p_button_image_alt=> 'Add Row',
  p_button_position=> 'BOTTOM',
...
wwv_flow_api.create_page_button(
  p_id             => 6924618396288284 + wwv_flow_api.g_id_offset,
  p_flow_id        => wwv_flow.g_flow_id,
  p_flow_step_id   => 3,
  p_button_sequence=> 30,
  p_button_plug_id => 6922807724288279+wwv_flow_api.g_id_offset,
...
wwv_flow_api.create_page_button(
  p_id             => 6924520178288284 + wwv_flow_api.g_id_offset,
  p_flow_id        => wwv_flow.g_flow_id,
  p_flow_step_id   => 3,
  p_button_sequence=> 10,
  p_button_plug_id => 6922807724288279+wwv_flow_api.g_id_offset,
...
wwv_flow_api.create_page_button(
  p_id             => 6933518455792315 + wwv_flow_api.g_id_offset,
  p_flow_id        => wwv_flow.g_flow_id,
  p_flow_step_id   => 3,
...
wwv_flow_api.create_page_button(
  p_id             => 6924725864288284 + wwv_flow_api.g_id_offset,
  p_flow_id        => wwv_flow.g_flow_id,
  p_flow_step_id   => 3,
  p_button_sequence=> 20,
  p_button_plug_id => 6922807724288279+wwv_flow_api.g_id_offset,
...
wwv_flow_api.create_page_branch(
  p_id=>6926010600288289 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_flow_step_id=> 3,
...
wwv_flow_api.create_page_item(
  p_id=>6926324824302684 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_flow_step_id=> 3,
  p_name=>'P3_DEPTNO',
  p_data_type=> 'VARCHAR',
  ...
  p_item_sequence=> 10,
  p_item_plug_id => 6922807724288279+wwv_flow_api.g_id_offset,
...
'',
  ...
  p_field_template=> 6810022090205817+wwv_flow_api.g_id_offset,
  p_is_persistent=> 'Y',
  p_attribute_01 => 'NONE',
  p_attribute_02 => 'N',
  p_item_comment => '');
...
begin
wwv_flow_api.create_page_item(
  p_id=>6926532097304718 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_flow_step_id=> 3,
  p_name=>'P3_GO',
  p_data_type=> 'VARCHAR',
...
wwv_flow_api.create_page_validation(
  p_id => 6933407027789071 + wwv_flow_api.g_id_offset,
  p_flow_id => wwv_flow.g_flow_id,
  p_flow_step_id => 3,
  p_tabular_form_region_id => null + wwv_flow_api.g_id_offset,
  p_validation_name => 'Validate Collection Data',
  p_validation_sequence=> 10,
  p_validation => 'BEGIN'||chr(10)||
'   RETURN tab_form_emp_pkg.validate_collection_data;'||chr(10)||
'END;',
  p_validation_type => 'FUNC_BODY_RETURNING_ERR_TEXT',
  p_error_message => '',
  p_always_execute=>'N',
  p_when_button_pressed=> 6933518455792315 + wwv_flow_api.g_id_offset,
  p_error_display_location=>'INLINE_IN_NOTIFICATION',
  p_validation_comment=> '');
...
begin
p:=p||'BEGIN'||chr(10)||
'  tab_form_emp_pkg.update_table_from_collection (:p3_deptno, :t_message);'||chr(10)||
'END;';

wwv_flow_api.create_page_process(
  p_id     => 6933832438805798 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_flow_step_id => 3,
  p_process_sequence=> 10,
  p_process_point=> 'AFTER_SUBMIT',
  p_process_type=> 'PLSQL',
  p_process_name=> 'Save Collection to Table',
  p_process_sql_clob => p, 
  p_process_error_message=> '',
  p_process_when_button_id=>6933518455792315 + wwv_flow_api.g_id_offset,
  p_process_success_message=> '&T_MESSAGE.',
  p_process_is_stateful_y_n=>'N',
  p_process_comment=>'');
end;
...
begin
p:=p||'BEGIN'||chr(10)||
'   tab_form_emp_pkg.create_emp_collection (:p3_deptno, :t_message);'||chr(10)||
'END;';

wwv_flow_api.create_page_process(
  p_id     => 6926621838311256 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_flow_step_id => 3,
  p_process_sequence=> 30,
  p_process_point=> 'AFTER_SUBMIT',
...
begin
p:=p||'BEGIN'||chr(10)||
'   tab_form_emp_pkg.save_emp_coll_custom (:t_message);'||chr(10)||
'END;';

wwv_flow_api.create_page_process(
  p_id     => 6928804120552176 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_flow_step_id => 3,
  p_process_sequence=> 40,
  p_process_point=> 'AFTER_SUBMIT',
...
begin
p:=p||'BEGIN'||chr(10)||
'   tab_form_emp_pkg.delete_emp_coll_custom (:t_message);'||chr(10)||
'END;';

wwv_flow_api.create_page_process(
  p_id     => 6929013817554957 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_flow_step_id => 3,
  p_process_sequence=> 50,
  p_process_point=> 'AFTER_SUBMIT',
  p_process_type=> 'PLSQL',
  p_process_name=> 'Delete Collection Member',
  p_process_sql_clob => p, 
  p_process_error_message=> '',
  p_process_when=>':REQUEST IN (''MULTI_ROW_DELETE'')',
  p_process_when_type=>'PLSQL_EXPRESSION',
...
wwv_flow_api.create_region_rpt_cols (
  p_id     => 6927400611522712 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_plug_id=> 6922807724288279 + wwv_flow_api.g_id_offset,
  p_column_sequence=> 1,
...
wwv_flow_api.create_region_rpt_cols (
  p_id     => 6927521503522712 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_plug_id=> 6922807724288279 + wwv_flow_api.g_id_offset,
  p_column_sequence=> 2,
  p_query_column_name=> 'EMPNO',
...
wwv_flow_api.create_region_rpt_cols (
  p_id     => 6927600788522712 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_plug_id=> 6922807724288279 + wwv_flow_api.g_id_offset,
  p_column_sequence=> 3,
  p_query_column_name=> 'SEQ_ID_DISPLAY',
  p_display_as=> 'TEXT',
  p_column_comment=> '');
 
wwv_flow_api.create_region_rpt_cols (
  p_id     => 6927710838522712 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_plug_id=> 6922807724288279 + wwv_flow_api.g_id_offset,
  p_column_sequence=> 4,
  p_query_column_name=> 'EMPNO_DISPLAY',
...
wwv_flow_api.create_region_rpt_cols (
  p_id     => 6927819063522712 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_plug_id=> 6922807724288279 + wwv_flow_api.g_id_offset,
  p_column_sequence=> 5,
  p_query_column_name=> 'ENAME',
...
wwv_flow_api.create_region_rpt_cols (
  p_id     => 6927925455522712 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_plug_id=> 6922807724288279 + wwv_flow_api.g_id_offset,
  p_column_sequence=> 6,
  p_query_column_name=> 'JOB',
...
wwv_flow_api.create_region_rpt_cols (
  p_id     => 6928029397522712 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_plug_id=> 6922807724288279 + wwv_flow_api.g_id_offset,
  p_column_sequence=> 7,
  p_query_column_name=> 'MGR',
...
wwv_flow_api.create_region_rpt_cols (
  p_id     => 6928128133522712 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_plug_id=> 6922807724288279 + wwv_flow_api.g_id_offset,
  p_column_sequence=> 8,
  p_query_column_name=> 'HIREDATE',
...
wwv_flow_api.create_region_rpt_cols (
  p_id     => 6928218849522712 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_plug_id=> 6922807724288279 + wwv_flow_api.g_id_offset,
  p_column_sequence=> 9,
  p_query_column_name=> 'SAL',
...
wwv_flow_api.create_region_rpt_cols (
  p_id     => 6928321830522712 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_plug_id=> 6922807724288279 + wwv_flow_api.g_id_offset,
  p_column_sequence=> 10,
  p_query_column_name=> 'COMM',
...
wwv_flow_api.create_region_rpt_cols (
  p_id     => 6928422995522712 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_plug_id=> 6922807724288279 + wwv_flow_api.g_id_offset,
  p_column_sequence=> 11,
  p_query_column_name=> 'DEPTNO',
...
wwv_flow_api.create_region_rpt_cols (
  p_id     => 6928516836522712 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_plug_id=> 6922807724288279 + wwv_flow_api.g_id_offset,
...
wwv_flow_api.create_region_rpt_cols (
  p_id     => 6928602679522712 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_plug_id=> 6922807724288279 + wwv_flow_api.g_id_offset,
  p_column_sequence=> 13,
  p_query_column_name=> 'CHECKSUM',
  p_display_as=> 'TEXT',
  p_column_comment=> '');
 
wwv_flow_api.create_region_rpt_cols (
  p_id     => 6928705126522712 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_plug_id=> 6922807724288279 + wwv_flow_api.g_id_offset,
  p_column_sequence=> 14,
  p_query_column_name=> 'DELETE_FLAG',
  p_display_as=> 'TEXT',
  p_column_comment=> '');
...
wwv_flow_api.create_page (
 ...
 ,p_id => 4
 ,p_tab_set => 'TS1'
 ,p_name => 'Tabular Form 4'
 ,p_step_title => 'Tabular Form 4'
 ,p_allow_duplicate_submissions => 'Y'
 ,p_step_sub_title => 'Tabular Form 4'
 ,p_step_sub_title_type => 'TEXT_WITH_SUBSTITUTIONS'
 ,p_first_item => 'AUTO_FIRST_ITEM'
 ,p_include_apex_css_js_yn => 'Y'
 ,p_autocomplete_on_off => 'ON'
...
''||chr(10)||
'function fn_delete(pThis)'||chr(10)||
'{'||chr(10)||
'   var l_tr=$x_UpTill(pThis,''TR'');'||chr(10)||
'   l_tr.parentNode.removeChild(l_tr);'||chr(10)||
'}'||chr(10)||
''||chr(10)||
'function fn_CloneRow(pThis) {'||chr(10)||
'         // Clone row'||chr(10)||
'         $(pThis).parent().parent().clone(true,false).insertAfter($(pThis).parent().parent());'||chr(10)||
''||chr(10)||
'	// get next row'||chr(10)||
'	n'||
'ewRow = $(pThis).parent().parent().next();'||chr(10)||
''||chr(10)||
'	// reset row identifier and set default values for some fields'||chr(10)||
'	newRow.find(''[type=hidden]'').val('''');'||chr(10)||
'	newRow.find(''[name=fcs]'').val(''Z'');'||chr(10)||
'	newRow.find(''[type=checkbox]'').remove();'||chr(10)||
''||chr(10)||
'	// highlight the row'||chr(10)||
'	html_RowHighlight($(newRow).get(0),"#9E0200");'||chr(10)||
''||chr(10)||
'	// toggle clone to delete functionality'||chr(10)||
'	newLink = $(newRow).find(''img'')[0];'||chr(10)||
'	newLink.src = ''/i/del.g'||
'if'';'||chr(10)||
'	$(newLink).parent().removeAttr(''onclick'');'||chr(10)||
'	$(newLink).parent().get(0).onclick = function() {'||chr(10)||
'		fn_delete(this)'||chr(10)||
'	};'||chr(10)||
'}'||chr(10)||
'</script>'
 ,p_javascript_code => 
...
'No help is available for this page.'
 ,p_last_updated_by => 'ORA_EXPERTS'
 ,p_last_upd_yyyymmddhh24miss => '20110226175020'
  );
null;
...
declare
  ...
  l_length number := 1;
begin
s:=s||'SELECT empno, NULL clone, empno empno_display, ename, job, mgr, hiredate, sal,'||chr(10)||
'       comm, deptno, valid'||chr(10)||
'  FROM emp'||chr(10)||
'';

wwv_flow_api.create_report_region (
  p_id=> 6910001732410148 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_page_id=> 4,
  p_name=> 'Tabular Form on EMP Table',
  p_region_name=>'',
...
s := null;
wwv_flow_api.create_report_columns (
  p_id=> 6911313500410151 + wwv_flow_api.g_id_offset,
  p_region_id=> 6910001732410148 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_query_column_id=> 1,
  p_form_element_id=> null,
  p_column_alias=> 'CHECK$01',
...
s := null;
wwv_flow_api.create_report_columns (
  p_id=> 6910328803410150 + wwv_flow_api.g_id_offset,
  p_region_id=> 6910001732410148 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_query_column_id=> 2,
  p_form_element_id=> null,
...
s := null;
wwv_flow_api.create_report_columns (
  p_id=> 6910223659410150 + wwv_flow_api.g_id_offset,
  p_region_id=> 6910001732410148 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_query_column_id=> 3,
  p_form_element_id=> null,
  ...
  p_column_display_sequence=> 2,
  p_column_heading=> 'Clone',
  p_column_html_expression=>'<a href="#" onclick="javascript:fn_CloneRow(this);">'||chr(10)||
...
s := null;
wwv_flow_api.create_report_columns (
  p_id=> 6910413635410150 + wwv_flow_api.g_id_offset,
  p_region_id=> 6910001732410148 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_query_column_id=> 4,
  p_form_element_id=> null,
...
s := null;
wwv_flow_api.create_report_columns (
  p_id=> 6910528996410150 + wwv_flow_api.g_id_offset,
  p_region_id=> 6910001732410148 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_query_column_id=> 5,
  p_form_element_id=> null,
...
s := null;
wwv_flow_api.create_report_columns (
  p_id=> 6910627306410150 + wwv_flow_api.g_id_offset,
  p_region_id=> 6910001732410148 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_query_column_id=> 6,
  p_form_element_id=> null,
...
s := null;
wwv_flow_api.create_report_columns (
  p_id=> 6910702566410150 + wwv_flow_api.g_id_offset,
  p_region_id=> 6910001732410148 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_query_column_id=> 7,
  p_form_element_id=> null,
...
s := null;
wwv_flow_api.create_report_columns (
  p_id=> 6910815908410150 + wwv_flow_api.g_id_offset,
  p_region_id=> 6910001732410148 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_query_column_id=> 8,
  p_form_element_id=> null,
...
s := null;
wwv_flow_api.create_report_columns (
  p_id=> 6910907814410150 + wwv_flow_api.g_id_offset,
  p_region_id=> 6910001732410148 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_query_column_id=> 9,
  p_form_element_id=> null,
...
s := null;
wwv_flow_api.create_report_columns (
  p_id=> 6911013461410150 + wwv_flow_api.g_id_offset,
  p_region_id=> 6910001732410148 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_query_column_id=> 10,
  p_form_element_id=> null,
...
s := null;
wwv_flow_api.create_report_columns (
  p_id=> 6911108061410150 + wwv_flow_api.g_id_offset,
  p_region_id=> 6910001732410148 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_query_column_id=> 11,
  p_form_element_id=> null,
...
s := null;
wwv_flow_api.create_report_columns (
  p_id=> 6911229431410150 + wwv_flow_api.g_id_offset,
  p_region_id=> 6910001732410148 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_query_column_id=> 12,
  p_form_element_id=> null,
...
s := null;
wwv_flow_api.create_page_plug (
  p_id=> 6912224438410153 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_page_id=> 4,
  p_plug_name=> 'Breadcrumbs',
  p_region_name=>'',
...
wwv_flow_api.create_page_button(
  p_id             => 6912012968410153 + wwv_flow_api.g_id_offset,
  p_flow_id        => wwv_flow.g_flow_id,
  p_flow_step_id   => 4,
  p_button_sequence=> 40,
  p_button_plug_id => 6910001732410148+wwv_flow_api.g_id_offset,
  p_button_name    => 'ADD',
  p_button_image   => 'template:'||to_char(6804931462205814+wwv_flow_api.g_id_offset),
  p_button_image_alt=> 'Add Row',
  p_button_position=> 'BOTTOM',
...
wwv_flow_api.create_page_button(
  p_id             => 6911423422410151 + wwv_flow_api.g_id_offset,
  p_flow_id        => wwv_flow.g_flow_id,
  p_flow_step_id   => 4,
  p_button_sequence=> 30,
  p_button_plug_id => 6910001732410148+wwv_flow_api.g_id_offset,
...
wwv_flow_api.create_page_button(
  p_id             => 6911615105410151 + wwv_flow_api.g_id_offset,
  p_flow_id        => wwv_flow.g_flow_id,
  p_flow_step_id   => 4,
  p_button_sequence=> 10,
  p_button_plug_id => 6910001732410148+wwv_flow_api.g_id_offset,
...
wwv_flow_api.create_page_button(
  p_id             => 6911805844410151 + wwv_flow_api.g_id_offset,
  p_flow_id        => wwv_flow.g_flow_id,
  p_flow_step_id   => 4,
  p_button_sequence=> 20,
  p_button_plug_id => 6910001732410148+wwv_flow_api.g_id_offset,
...
wwv_flow_api.create_page_branch(
  p_id=>6914105618410154 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_flow_step_id=> 4,
...
wwv_flow_api.create_page_validation(
  p_id => 6912531626410153 + wwv_flow_api.g_id_offset,
  p_flow_id => wwv_flow.g_flow_id,
  p_flow_step_id => 4,
  p_tabular_form_region_id => 6910001732410148 + wwv_flow_api.g_id_offset,
  p_validation_name => 'ENAME not null',
  p_validation_sequence=> 30,
  p_validation => 'ENAME',
  p_validation_type => 'COL_NOT_NULL',
  p_error_message => '#COLUMN_HEADER# must have a value.',
  p_when_button_pressed=> 6911423422410151 + wwv_flow_api.g_id_offset,
  p_associated_column=> 'ENAME',
  p_error_display_location=>'INLINE_WITH_FIELD_AND_NOTIFICATION',
  p_validation_comment=> '');
...
wwv_flow_api.create_page_validation(
  p_id => 6912732093410153 + wwv_flow_api.g_id_offset,
  p_flow_id => wwv_flow.g_flow_id,
  p_flow_step_id => 4,
  p_tabular_form_region_id => 6910001732410148 + wwv_flow_api.g_id_offset,
  p_validation_name => 'MGR must be numeric',
...
wwv_flow_api.create_page_validation(
  p_id => 6912916278410153 + wwv_flow_api.g_id_offset,
  p_flow_id => wwv_flow.g_flow_id,
  p_flow_step_id => 4,
  p_tabular_form_region_id => 6910001732410148 + wwv_flow_api.g_id_offset,
  p_validation_name => 'HIREDATE must be a valid date',
...
wwv_flow_api.create_page_validation(
  p_id => 6913130326410153 + wwv_flow_api.g_id_offset,
  p_flow_id => wwv_flow.g_flow_id,
  p_flow_step_id => 4,
  p_tabular_form_region_id => 6910001732410148 + wwv_flow_api.g_id_offset,
  p_validation_name => 'SAL must be numeric',
...
wwv_flow_api.create_page_validation(
  p_id => 6913302324410153 + wwv_flow_api.g_id_offset,
  p_flow_id => wwv_flow.g_flow_id,
  p_flow_step_id => 4,
  p_tabular_form_region_id => 6910001732410148 + wwv_flow_api.g_id_offset,
  p_validation_name => 'COMM must be numeric',
...
wwv_flow_api.create_page_validation(
  p_id => 6913507312410154 + wwv_flow_api.g_id_offset,
  p_flow_id => wwv_flow.g_flow_id,
  p_flow_step_id => 4,
  p_tabular_form_region_id => 6910001732410148 + wwv_flow_api.g_id_offset,
  p_validation_name => 'DEPTNO must be numeric',
...
wwv_flow_api.create_page_process(
  p_id     => 6913600660410154 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_flow_step_id => 4,
  p_process_sequence=> 10,
  p_process_point=> 'AFTER_SUBMIT',
  ...
  p_process_sql_clob => p, 
  p_process_error_message=> 'Unable to process update.',
  p_process_when_button_id=>6911423422410151 + wwv_flow_api.g_id_offset,
  p_process_success_message=> '#MRU_COUNT# row(s) updated, #MRI_COUNT# row(s) inserted.',
  p_process_is_stateful_y_n=>'N',
  p_process_comment=>'');
end;
...
wwv_flow_api.create_page_process(
  p_id     => 6913825551410154 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_flow_step_id => 4,
  p_process_sequence=> 20,
  p_process_point=> 'AFTER_SUBMIT',
...
wwv_flow_api.create_page (
 ...
 ,p_step_template => 6803401027205807 + wwv_flow_api.g_id_offset
 ,p_page_is_public_y_n => 'N'
 ,p_cache_page_yn => 'N'
 ,p_last_upd_yyyymmddhh24miss => '20110222131617'
  );
null;
...
s := null;
wwv_flow_api.create_page_plug (
  p_id=> 6812004937205831 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_page_id=> 101,
  p_plug_name=> 'Login',
  p_region_name=>'',
  p_plug_template=> 6805912803205814+ wwv_flow_api.g_id_offset,
...
begin
wwv_flow_api.create_page_item(
  p_id=>6812105420205834 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_flow_step_id=> 101,
  ...
  p_accept_processing=> 'REPLACE_EXISTING',
  p_item_sequence=> 10,
  p_item_plug_id => 6812004937205831+wwv_flow_api.g_id_offset,
  ...
  p_label_alignment=> 'RIGHT',
  p_field_alignment=> 'LEFT',
  p_field_template=> 6810105561205817+wwv_flow_api.g_id_offset,
  p_is_persistent=> 'Y',
  p_attribute_01 => 'N',
  p_attribute_02 => 'N',
  p_attribute_03 => 'N',
...
begin
wwv_flow_api.create_page_item(
  p_id=>6812231077205834 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_flow_step_id=> 101,
...
begin
wwv_flow_api.create_page_item(
  p_id=>6812331791205834 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_flow_step_id=> 101,
  p_name=>'P101_LOGIN',
  p_data_type=> '',
  ...
  p_cMaxlength=> null,
  p_cHeight=> null,
  p_tag_attributes  => 'template:'||to_char(6804931462205814 + wwv_flow_api.g_id_offset),
  p_begin_on_new_line=> 'NO',
  p_begin_on_new_field=> 'YES',
  p_colspan=> 1,
  p_rowspan=> 1,
...
wwv_flow_api.create_page_process(
  p_id     => 6812519095205835 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_flow_step_id => 101,
  p_process_sequence=> 10,
  p_process_point=> 'AFTER_SUBMIT',
...
wwv_flow_api.create_page_process(
  p_id     => 6812417933205834 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_flow_step_id => 101,
  p_process_sequence=> 20,
  p_process_point=> 'AFTER_SUBMIT',
...
wwv_flow_api.create_page_process(
  p_id     => 6812711704205835 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_flow_step_id => 101,
  p_process_sequence=> 30,
  p_process_point=> 'AFTER_SUBMIT',
...
wwv_flow_api.create_page_process(
  p_id     => 6812616405205835 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_flow_step_id => 101,
  p_process_sequence=> 10,
...
wwv_flow_api.create_menu (
  p_id=> 6812821242205835 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_name=> ' Breadcrumb');
 
wwv_flow_api.create_menu_option (
  p_id=>6813305986205839 + wwv_flow_api.g_id_offset,
  p_menu_id=>6812821242205835 + wwv_flow_api.g_id_offset,
  p_parent_id=>0,
  p_option_sequence=>10,
  p_short_name=>'Tabular Form 1',
  p_long_name=>'',
  p_link=>'f?p=100:1:&SESSION.',
  p_page_id=>1,
...
prompt  ......Page template 6803401027205807
...
wwv_flow_api.create_template(
  p_id=> 6803401027205807 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_name=> 'Login',
  p_body_title=> '',
...
prompt  ......Page template 6803511729205807
...
wwv_flow_api.create_template(
  p_id=> 6803511729205807 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
...
prompt  ......Page template 6803600576205807
...
wwv_flow_api.create_template(
  p_id=> 6803600576205807 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
...
prompt  ......Page template 6803724633205807
...
wwv_flow_api.create_template(
  p_id=> 6803724633205807 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
...
prompt  ......Page template 6803828693205807
...
wwv_flow_api.create_template(
  p_id=> 6803828693205807 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
...
prompt  ......Page template 6803929388205807
...
wwv_flow_api.create_template(
  p_id=> 6803929388205807 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
...
prompt  ......Page template 6804016240205807
...
wwv_flow_api.create_template(
  p_id=> 6804016240205807 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
...
prompt  ......Page template 6804109342205807
...
wwv_flow_api.create_template(
  p_id=> 6804109342205807 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
...
prompt  ......Page template 6804225024205809
...
wwv_flow_api.create_template(
  p_id=> 6804225024205809 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
...
prompt  ......Page template 6804332501205809
...
wwv_flow_api.create_template(
  p_id=> 6804332501205809 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_name=> 'Popup',
  p_body_title=> '',
  p_header_template=> c1,
...
prompt  ......Page template 6804425070205809
...
wwv_flow_api.create_template(
  p_id=> 6804425070205809 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
...
prompt  ......Page template 6804514736205810
...
wwv_flow_api.create_template(
  p_id=> 6804514736205810 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
...
prompt  ......Page template 6804604677205812
...
wwv_flow_api.create_template(
  p_id=> 6804604677205812 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
...
prompt  ......Page template 6804725646205812
...
wwv_flow_api.create_template(
  p_id=> 6804725646205812 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
...
prompt  ......Page template 6804829098205812
...
wwv_flow_api.create_template(
  p_id=> 6804829098205812 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
...
prompt  ......Button Template 6804931462205814
declare
...
wwv_flow_api.create_button_templates (
  p_id=>6804931462205814 + wwv_flow_api.g_id_offset,
  p_flow_id=>wwv_flow.g_flow_id,
  p_template=>t,
...
prompt  ......Button Template 6805014521205814
declare
  t varchar2(32767) := null;
  l_clob clob;
  l_length number := 1;
...
wwv_flow_api.create_button_templates (
  p_id=>6805014521205814 + wwv_flow_api.g_id_offset,
  p_flow_id=>wwv_flow.g_flow_id,
  p_template=>t,
...
prompt  ......Button Template 6805100550205814
declare
  t varchar2(32767) := null;
  l_clob clob;
  l_length number := 1;
...
wwv_flow_api.create_button_templates (
  p_id=>6805100550205814 + wwv_flow_api.g_id_offset,
  p_flow_id=>wwv_flow.g_flow_id,
  p_template=>t,
...
prompt  ......Button Template 6805208860205814
declare
  t varchar2(32767) := null;
  l_clob clob;
  l_length number := 1;
...
wwv_flow_api.create_button_templates (
  p_id=>6805208860205814 + wwv_flow_api.g_id_offset,
  p_flow_id=>wwv_flow.g_flow_id,
  p_template=>t,
...
prompt  ......region template 6805305879205814
 
begin
 
wwv_flow_api.create_plug_template (
  p_id => 6805305879205814 + wwv_flow_api.g_id_offset
 ,p_flow_id => wwv_flow.g_flow_id
 ,p_template => 
...
prompt  ......region template 6805420157205814
 
begin
 
wwv_flow_api.create_plug_template (
  p_id => 6805420157205814 + wwv_flow_api.g_id_offset
 ,p_flow_id => wwv_flow.g_flow_id
 ,p_template => 
...
prompt  ......region template 6805502383205814
 
begin
 
wwv_flow_api.create_plug_template (
  p_id => 6805502383205814 + wwv_flow_api.g_id_offset
 ,p_flow_id => wwv_flow.g_flow_id
 ,p_template => 
...
prompt  ......region template 6805622431205814
 
begin
 
wwv_flow_api.create_plug_template (
  p_id => 6805622431205814 + wwv_flow_api.g_id_offset
 ,p_flow_id => wwv_flow.g_flow_id
 ,p_template => 
'<div class="borderless-region" id="#REGION_STATIC_ID#" #REGION_ATTRIBUTES#>'||chr(10)||
'  <div class="bl-top">'||chr(10)||
...
prompt  ......region template 6805711975205814
 
begin
 
wwv_flow_api.create_plug_template (
  p_id => 6805711975205814 + wwv_flow_api.g_id_offset
 ,p_flow_id => wwv_flow.g_flow_id
 ,p_template => 
'<div class="borderless-region" id="#REGION_STATIC_ID#" #REGION_ATTRIBUTES#>'||chr(10)||
'  <div class="bl-top">'||chr(10)||
...
prompt  ......region template 6805816509205814
 
begin
 
wwv_flow_api.create_plug_template (
  p_id => 6805816509205814 + wwv_flow_api.g_id_offset
 ,p_flow_id => wwv_flow.g_flow_id
 ,p_template => 
...
prompt  ......region template 6805912803205814
 
begin
 
wwv_flow_api.create_plug_template (
  p_id => 6805912803205814 + wwv_flow_api.g_id_offset
 ,p_flow_id => wwv_flow.g_flow_id
 ,p_template => 
'<div class="rounded-corner-region" id="#REGION_STATIC_ID#" #REGION_ATTRIBUTES#>'||chr(10)||
...
prompt  ......region template 6806030347205814
 
begin
 
wwv_flow_api.create_plug_template (
  p_id => 6806030347205814 + wwv_flow_api.g_id_offset
 ,p_flow_id => wwv_flow.g_flow_id
 ,p_template => 
...
prompt  ......region template 6806118353205814
 
begin
 
wwv_flow_api.create_plug_template (
  p_id => 6806118353205814 + wwv_flow_api.g_id_offset
 ,p_flow_id => wwv_flow.g_flow_id
 ,p_template => 
'<div class="rounded-corner-region" id="#REGION_STATIC_ID#" #REGION_ATTRIBUTES#>'||chr(10)||
'  <div class="rc-red-top"><div class="rc-red-top-r">'||chr(10)||
...
prompt  ......region template 6806209191205814
 
begin
 
wwv_flow_api.create_plug_template (
  p_id => 6806209191205814 + wwv_flow_api.g_id_offset
 ,p_flow_id => wwv_flow.g_flow_id
 ,p_template => 
...
prompt  ......region template 6806329682205814
 
begin
 
wwv_flow_api.create_plug_template (
  p_id => 6806329682205814 + wwv_flow_api.g_id_offset
 ,p_flow_id => wwv_flow.g_flow_id
 ,p_template => 
...
prompt  ......region template 6806418838205814
 
begin
 
wwv_flow_api.create_plug_template (
  p_id => 6806418838205814 + wwv_flow_api.g_id_offset
 ,p_flow_id => wwv_flow.g_flow_id
 ,p_template => 
'<div class="borderless-region" id="#REGION_STATIC_ID#" #REGION_ATTRIBUTES#>'||chr(10)||
'  <div class="bl-body">#BODY#</div>'||chr(10)||
...
prompt  ......region template 6806531607205814
 
begin
 
wwv_flow_api.create_plug_template (
  p_id => 6806531607205814 + wwv_flow_api.g_id_offset
 ,p_flow_id => wwv_flow.g_flow_id
 ,p_template => 
'<div class="borderless-region" id="#REGION_STATIC_ID#" #REGION_ATTRIBUTES#>'||chr(10)||
'  <div class="bl-top">'||chr(10)||
...
prompt  ......region template 6806621293205814
 
begin
 
wwv_flow_api.create_plug_template (
  p_id => 6806621293205814 + wwv_flow_api.g_id_offset
 ,p_flow_id => wwv_flow.g_flow_id
 ,p_template => 
...
prompt  ......region template 6806718895205814
 
begin
 
wwv_flow_api.create_plug_template (
  p_id => 6806718895205814 + wwv_flow_api.g_id_offset
 ,p_flow_id => wwv_flow.g_flow_id
 ,p_template => 
'<div class="rounded-corner-region" id="#REGION_STATIC_ID#" #REGION_ATTRIBUTES#>'||chr(10)||
'  <div class="rc-gray-top"><div class="rc-gray-top-r">'||chr(10)||
...
prompt  ......region template 6806827117205814
 
begin
 
wwv_flow_api.create_plug_template (
  p_id => 6806827117205814 + wwv_flow_api.g_id_offset
 ,p_flow_id => wwv_flow.g_flow_id
 ,p_template => 
...
prompt  ......region template 6806904745205814
 
begin
 
wwv_flow_api.create_plug_template (
  p_id => 6806904745205814 + wwv_flow_api.g_id_offset
 ,p_flow_id => wwv_flow.g_flow_id
 ,p_template => 
'<div class="rounded-corner-region" id="#REGION_STATIC_ID#" #REGION_ATTRIBUTES#>'||chr(10)||
'  <div class="rc-red-top"><div class="rc-red-top-r">'||chr(10)||
...
prompt  ......region template 6807001662205814
 
begin
 
wwv_flow_api.create_plug_template (
  p_id => 6807001662205814 + wwv_flow_api.g_id_offset
 ,p_flow_id => wwv_flow.g_flow_id
 ,p_template => 
...
prompt  ......region template 6807119771205814
 
begin
 
wwv_flow_api.create_plug_template (
  p_id => 6807119771205814 + wwv_flow_api.g_id_offset
 ,p_flow_id => wwv_flow.g_flow_id
 ,p_template => 
...
prompt  ......region template 6807228558205814
 
begin
 
wwv_flow_api.create_plug_template (
  p_id => 6807228558205814 + wwv_flow_api.g_id_offset
 ,p_flow_id => wwv_flow.g_flow_id
 ,p_template => 
...
prompt  ......region template 6807329843205814
 
begin
 
wwv_flow_api.create_plug_template (
  p_id => 6807329843205814 + wwv_flow_api.g_id_offset
 ,p_flow_id => wwv_flow.g_flow_id
 ,p_template => 
'<div class="rounded-corner-region" id="#REGION_STATIC_ID#" #REGION_ATTRIBUTES#>'||chr(10)||
'  <div class="rc-red-top"><div class="rc-red-top-r">'||chr(10)||
...
prompt  ......region template 6807418688205814
 
begin
 
wwv_flow_api.create_plug_template (
  p_id => 6807418688205814 + wwv_flow_api.g_id_offset
 ,p_flow_id => wwv_flow.g_flow_id
 ,p_template => 
'<div class="rounded-corner-region" id="#REGION_STATIC_ID#" #REGION_ATTRIBUTES#>'||chr(10)||
'  <div class="rc-red-top"><div class="rc-red-top-r">'||chr(10)||
...
prompt  ......list template 6807514065205814
...
wwv_flow_api.create_list_template (
  p_id=>6807514065205814 + wwv_flow_api.g_id_offset,
  p_flow_id=>wwv_flow.g_flow_id,
...
prompt  ......list template 6807625193205814
...
wwv_flow_api.create_list_template (
  p_id=>6807625193205814 + wwv_flow_api.g_id_offset,
  p_flow_id=>wwv_flow.g_flow_id,
  p_list_template_current=>t,
  p_list_template_noncurrent=> t2,
...
prompt  ......list template 6807706985205814
...
wwv_flow_api.create_list_template (
  p_id=>6807706985205814 + wwv_flow_api.g_id_offset,
  p_flow_id=>wwv_flow.g_flow_id,
  p_list_template_current=>t,
  p_list_template_noncurrent=> t2,
...
prompt  ......list template 6807825873205814
...
t8 := null;
wwv_flow_api.create_list_template (
  p_id=>6807825873205814 + wwv_flow_api.g_id_offset,
  p_flow_id=>wwv_flow.g_flow_id,
  p_list_template_current=>t,
  p_list_template_noncurrent=> t2,
...
prompt  ......list template 6807903892205814
...
t8 := null;
wwv_flow_api.create_list_template (
  p_id=>6807903892205814 + wwv_flow_api.g_id_offset,
  p_flow_id=>wwv_flow.g_flow_id,
  p_list_template_current=>t,
  p_list_template_noncurrent=> t2,
...
prompt  ......list template 6808010423205814
...
wwv_flow_api.create_list_template (
  p_id=>6808010423205814 + wwv_flow_api.g_id_offset,
  p_flow_id=>wwv_flow.g_flow_id,
  p_list_template_current=>t,
  p_list_template_noncurrent=> t2,
...
prompt  ......list template 6808129559205814
...
wwv_flow_api.create_list_template (
  p_id=>6808129559205814 + wwv_flow_api.g_id_offset,
  p_flow_id=>wwv_flow.g_flow_id,
  p_list_template_current=>t,
  p_list_template_noncurrent=> t2,
...
prompt  ......list template 6808209151205815
...
t8 := null;
wwv_flow_api.create_list_template (
  p_id=>6808209151205815 + wwv_flow_api.g_id_offset,
  p_flow_id=>wwv_flow.g_flow_id,
  p_list_template_current=>t,
  p_list_template_noncurrent=> t2,
...
prompt  ......list template 6808306774205815
...
t8 := null;
wwv_flow_api.create_list_template (
  p_id=>6808306774205815 + wwv_flow_api.g_id_offset,
  p_flow_id=>wwv_flow.g_flow_id,
  p_list_template_current=>t,
  p_list_template_noncurrent=> t2,
...
prompt  ......list template 6808428314205815
...
t8 := null;
wwv_flow_api.create_list_template (
  p_id=>6808428314205815 + wwv_flow_api.g_id_offset,
  p_flow_id=>wwv_flow.g_flow_id,
  p_list_template_current=>t,
  p_list_template_noncurrent=> t2,
...
prompt  ......list template 6808522595205815
...
t8 := null;
wwv_flow_api.create_list_template (
  p_id=>6808522595205815 + wwv_flow_api.g_id_offset,
  p_flow_id=>wwv_flow.g_flow_id,
  p_list_template_current=>t,
  p_list_template_noncurrent=> t2,
...
prompt  ......list template 6808631621205815
...
t8 := null;
wwv_flow_api.create_list_template (
  p_id=>6808631621205815 + wwv_flow_api.g_id_offset,
  p_flow_id=>wwv_flow.g_flow_id,
  p_list_template_current=>t,
  p_list_template_noncurrent=> t2,
...
prompt  ......list template 6808720042205815
...
t8 := null;
wwv_flow_api.create_list_template (
  p_id=>6808720042205815 + wwv_flow_api.g_id_offset,
  p_flow_id=>wwv_flow.g_flow_id,
  p_list_template_current=>t,
  p_list_template_noncurrent=> t2,
...
prompt  ......list template 6808817142205815
...
t8 := null;
wwv_flow_api.create_list_template (
  p_id=>6808817142205815 + wwv_flow_api.g_id_offset,
  p_flow_id=>wwv_flow.g_flow_id,
  p_list_template_current=>t,
  p_list_template_noncurrent=> t2,
...
prompt  ......list template 6808905318205815
...
t8 := null;
wwv_flow_api.create_list_template (
  p_id=>6808905318205815 + wwv_flow_api.g_id_offset,
  p_flow_id=>wwv_flow.g_flow_id,
  p_list_template_current=>t,
  p_list_template_noncurrent=> t2,
...
prompt  ......report template 6809002632205815
...
wwv_flow_api.create_row_template (
  p_id=> 6809002632205815 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
...
prompt  ......report template 6809123179205817
...
c4 := null;
wwv_flow_api.create_row_template (
  p_id=> 6809123179205817 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
...
prompt  ......report template 6809225999205817
...
c4 := null;
wwv_flow_api.create_row_template (
  p_id=> 6809225999205817 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
...
prompt  ......report template 6809306091205817
...
c4 := null;
wwv_flow_api.create_row_template (
  p_id=> 6809306091205817 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
...
prompt  ......report template 6809430354205817
...
c4 := null;
wwv_flow_api.create_row_template (
  p_id=> 6809430354205817 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
...
prompt  ......report template 6809504814205817
...
c4 := null;
wwv_flow_api.create_row_template (
  p_id=> 6809504814205817 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
...
prompt  ......report template 6809600611205817
...
c4 := null;
wwv_flow_api.create_row_template (
  p_id=> 6809600611205817 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
...
prompt  ......report template 6809717894205817
...
c4 := null;
wwv_flow_api.create_row_template (
  p_id=> 6809717894205817 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
...
prompt  ......report template 6809805134205817
...
c4 := null;
wwv_flow_api.create_row_template (
  p_id=> 6809805134205817 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
...
prompt  ......label template 6809917414205817
 
begin
 
begin
wwv_flow_api.create_field_template (
  p_id=> 6809917414205817 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
...
prompt  ......label template 6810022090205817
 
begin
 
begin
wwv_flow_api.create_field_template (
  p_id=> 6810022090205817 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
...
prompt  ......label template 6810105561205817
 
begin
 
begin
wwv_flow_api.create_field_template (
  p_id=> 6810105561205817 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
...
prompt  ......label template 6810226436205817
 
begin
 
begin
wwv_flow_api.create_field_template (
  p_id=> 6810226436205817 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
...
prompt  ......label template 6810317014205817
 
begin
 
begin
wwv_flow_api.create_field_template (
  p_id=> 6810317014205817 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
...
prompt  ......template 6810430924205817
 
begin
 
begin
wwv_flow_api.create_menu_template (
  p_id=> 6810430924205817 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
...
prompt  ......template 6810525218205817
 
begin
 
begin
wwv_flow_api.create_menu_template (
  p_id=> 6810525218205817 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
...
--
prompt  ......template 6811211570205820
 
begin
 
begin
wwv_flow_api.create_popup_lov_template (
  p_id=> 6811211570205820 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
...
prompt  ......template 6810625749205817
 
begin
 
begin
wwv_flow_api.create_calendar_template(
  p_id=> 6810625749205817 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
...
prompt  ......template 6810818243205817
 
begin
 
begin
wwv_flow_api.create_calendar_template(
  p_id=> 6810818243205817 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
...
prompt  ......template 6811001657205817
 
begin
 
begin
wwv_flow_api.create_calendar_template(
  p_id=> 6811001657205817 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
...
prompt  ......theme 6811325097205820
begin
wwv_flow_api.create_theme (
  p_id =>6811325097205820 + wwv_flow_api.g_id_offset,
  p_flow_id =>wwv_flow.g_flow_id,
  p_theme_id  => 1,
  ...
  p_login_template=>6803401027205807 + wwv_flow_api.g_id_offset,
  p_default_button_template=>6804931462205814 + wwv_flow_api.g_id_offset,
  p_default_region_template=>6806718895205814 + wwv_flow_api.g_id_offset,
  p_default_chart_template =>6805816509205814 + wwv_flow_api.g_id_offset,
  p_default_form_template  =>6805912803205814 + wwv_flow_api.g_id_offset,
  ...
  p_default_label_template=>6810105561205817 + wwv_flow_api.g_id_offset,
  p_default_menu_template=>6810430924205817 + wwv_flow_api.g_id_offset,
  p_default_calendar_template=>6810625749205817 + wwv_flow_api.g_id_offset,
  p_default_list_template=>6808720042205815 + wwv_flow_api.g_id_offset,
  p_default_option_label=>6810105561205817 + wwv_flow_api.g_id_offset,
  p_default_required_label=>6810317014205817 + wwv_flow_api.g_id_offset);
end;
/
...
wwv_flow_api.create_shortcut (
 p_id=> 6815813677557518 + wwv_flow_api.g_id_offset,
 p_flow_id=> wwv_flow.g_flow_id,
...
prompt  ......scheme 6811405880205831
...
wwv_flow_api.create_auth_setup (
  p_id=> 6811405880205831 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
...
prompt  ......scheme 6811500170205831
...
s5 := null;
wwv_flow_api.create_auth_setup (
  p_id=> 6811500170205831 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_name=> 'DATABASE',
...
prompt  ......scheme 6811617892205831
...
s5 := null;
wwv_flow_api.create_auth_setup (
  p_id=> 6811617892205831 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
